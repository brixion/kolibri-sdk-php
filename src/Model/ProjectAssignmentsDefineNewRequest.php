...
/**
 * ProjectAssignmentsDefineNewRequest - Brixion Kolibri PHP SDK.
...
/**
 * ProjectAssignmentsDefineNewRequest.
 * @implements \ArrayAccess<string, mixed>
 */
class ProjectAssignmentsDefineNewRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'ProjectAssignmentsDefineNewRequest';
    ...
    */
    ...
    public function setEmployeeId($employee_id)
    {
        ...
        if ((mb_strlen($employee_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling ProjectAssignmentsDefineNewRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setOfficeId($office_id)
    {
        ...
        if ((mb_strlen($office_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $office_id when calling ProjectAssignmentsDefineNewRequest., must be bigger than or equal to 1.');
        }
