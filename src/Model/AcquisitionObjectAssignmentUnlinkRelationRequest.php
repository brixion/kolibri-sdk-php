...
/**
 * AcquisitionObjectAssignmentUnlinkRelationRequest - Brixion Kolibri PHP SDK.
...
/**
 * AcquisitionObjectAssignmentUnlinkRelationRequest.
 * @implements \ArrayAccess<string, mixed>
 */
class AcquisitionObjectAssignmentUnlinkRelationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'AcquisitionObjectAssignmentUnlinkRelationRequest';
    ...
    */
    ...
    public function setRelationId($relation_id)
    {
        ...
        if ((mb_strlen($relation_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $relation_id when calling AcquisitionObjectAssignmentUnlinkRelationRequest., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string $acquisition_object_assignment_id The acquisition object assignment to unlink the relation from.
     *
     * @return self
     */
    public function setAcquisitionObjectAssignmentId($acquisition_object_assignment_id)
    {
        ...
        if ((mb_strlen($acquisition_object_assignment_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $acquisition_object_assignment_id when calling AcquisitionObjectAssignmentUnlinkRelationRequest., must be bigger than or equal to 1.');
        }
