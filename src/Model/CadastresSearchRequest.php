...
/**
 * CadastresSearchRequest - Brixion Kolibri PHP SDK.
...
/**
 * CadastresSearchRequest.
 * @implements \ArrayAccess<string, mixed>
 */
class CadastresSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'CadastresSearchRequest';
    ...
    protected static $attributeTypes = [
        ...
        'order_by' => '\Brixion\Kolibri\Model\CadastreOrderByField',
        'term_fields' => '\Brixion\Kolibri\Model\CadastreTermField[]',
    ...
    {
        $this->setIfExists('cadastre_id', $data ?? [], null);
    ...
    */
     ...
     * Sets cadastre_id
     *
     * @param string|null $cadastre_id Search by a specific Cadastre Id. Used to return/refresh one search result.
     *
     * @return self
     */
    public function setCadastreId($cadastre_id)
    {
        if (is_null($cadastre_id)) {
            throw new \InvalidArgumentException('non-nullable cadastre_id cannot be null');
        }
     ...
     *
     * @param string|null $object_assignment_id Search by a specific ObjectAssignment Id.
     *
     * @return self
     */
     ...
     * Gets order_by
     *
     * @return \Brixion\Kolibri\Model\CadastreOrderByField
     */
     ...
     * Sets order_by
     *
     * @param \Brixion\Kolibri\Model\CadastreOrderByField $order_by Order the results by the indicated Cadastre field.
     *
     * @return self
     */
     ...
     * Gets term_fields
     *
     * @return \Brixion\Kolibri\Model\CadastreTermField[]|null
     */
     ...
     * Sets term_fields
     *
     * @param \Brixion\Kolibri\Model\CadastreTermField[]|null $term_fields Search for given text (Term) indicated by the fields in the TermFields list. Required in case 'Term' is given.
     *
     * @return self
     */
    ...
    public function setSkip($skip)
    {
        ...
        if (($skip > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling CadastresSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($skip < 0)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling CadastresSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTake($take)
    {
        ...
        if (($take > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $take when calling CadastresSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($take < 0)) {
            throw new \InvalidArgumentException('invalid value for $take when calling CadastresSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTerm($term)
    {
        ...
        if ((mb_strlen($term) > 50)) {
            throw new \InvalidArgumentException('invalid length for $term when calling CadastresSearchRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($term) < 0)) {
            throw new \InvalidArgumentException('invalid length for $term when calling CadastresSearchRequest., must be bigger than or equal to 0.');
        }
