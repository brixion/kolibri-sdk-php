...
/**
 * CompanyListingDefineNewRequest - Brixion Kolibri PHP SDK.
...
/**
 * CompanyListingDefineNewRequest.
 * @implements \ArrayAccess<string, mixed>
 */
class CompanyListingDefineNewRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'CompanyListingDefineNewRequest';
    ...
    */
     ...
     *
     * @param string $object_assignment_id The objectAssignment Id who is the owner of the company listing.
     *
     * @return self
     */
    public function setObjectAssignmentId($object_assignment_id)
    {
        ...
        if ((mb_strlen($object_assignment_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $object_assignment_id when calling CompanyListingDefineNewRequest., must be bigger than or equal to 1.');
        }
