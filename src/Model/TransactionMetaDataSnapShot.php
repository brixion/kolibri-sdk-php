...
/**
 * TransactionMetaDataSnapShot - Brixion Kolibri PHP SDK.
 ...
 */
class TransactionMetaDataSnapShot implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'TransactionMetaDataSnapShot';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling TransactionMetaDataSnapShot., must be bigger than or equal to 1.');
        }
