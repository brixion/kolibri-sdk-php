...
/**
 * PhraseSnapShot - Brixion Kolibri PHP SDK.
 ...
 */
class PhraseSnapShot implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'PhraseSnapShot';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling PhraseSnapShot., must be bigger than or equal to 1.');
        }
