...
/**
 * GenericAssignmentCategoriesMoveRequest - Brixion Kolibri PHP SDK.
...
/**
 * GenericAssignmentCategoriesMoveRequest.
 * @implements \ArrayAccess<string, mixed>
 */
class GenericAssignmentCategoriesMoveRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'GenericAssignmentCategoriesMoveRequest';
    ...
    */
    ...
    public function setOldCategoryId($old_category_id)
    {
        ...
        if ((mb_strlen($old_category_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $old_category_id when calling GenericAssignmentCategoriesMoveRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setNewCategoryId($new_category_id)
    {
        ...
        if ((mb_strlen($new_category_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $new_category_id when calling GenericAssignmentCategoriesMoveRequest., must be bigger than or equal to 1.');
        }
