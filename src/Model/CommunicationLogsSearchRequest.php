...
/**
 * CommunicationLogsSearchRequest - Brixion Kolibri PHP SDK.
 ...
 */
class CommunicationLogsSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'CommunicationLogsSearchRequest';
    ...
    protected static $attributeTypes = [
        'parent_id' => 'string',
        'order_by' => '\Brixion\Kolibri\Model\CommunicationLogOrderByField',
        'communication_log_id' => 'string',
        'term_fields' => '\Brixion\Kolibri\Model\CommunicationLogTermField[]',
    ...
    */
     ...
     * Sets parent_id
     *
     * @param string|null $parent_id Set the ParentId to search for communicationLogs by the Id of a ContactPerson or ContactCompany or by an AssignmentId.
     *
     * @return self
     */
     ...
     * Gets order_by
     *
     * @return \Brixion\Kolibri\Model\CommunicationLogOrderByField
     */
     ...
     * Sets order_by
     *
     * @param \Brixion\Kolibri\Model\CommunicationLogOrderByField $order_by Order the results by the indicated communicationLog field.
     *
     * @return self
     */
     ...
     *
     * @param string|null $communication_log_id Search by a specific communicationLog Id. Used to return/refresh one search result.
     *
     * @return self
     */
     ...
     * Gets term_fields
     *
     * @return \Brixion\Kolibri\Model\CommunicationLogTermField[]|null
     */
     ...
     * Sets term_fields
     *
     * @param \Brixion\Kolibri\Model\CommunicationLogTermField[]|null $term_fields Search for given text (Term) indicated by the fields in the TermFields list. Required in case 'Term' is given.
     *
     * @return self
     */
    ...
    public function setSkip($skip)
    {
        ...
        if (($skip > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling CommunicationLogsSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($skip < 0)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling CommunicationLogsSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTake($take)
    {
        ...
        if (($take > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $take when calling CommunicationLogsSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($take < 0)) {
            throw new \InvalidArgumentException('invalid value for $take when calling CommunicationLogsSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTerm($term)
    {
        ...
        if ((mb_strlen($term) > 50)) {
            throw new \InvalidArgumentException('invalid length for $term when calling CommunicationLogsSearchRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($term) < 0)) {
            throw new \InvalidArgumentException('invalid length for $term when calling CommunicationLogsSearchRequest., must be bigger than or equal to 0.');
        }
