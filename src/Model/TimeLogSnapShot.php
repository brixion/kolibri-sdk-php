...
/**
 * TimeLogSnapShot - Brixion Kolibri PHP SDK.
 ...
 */
class TimeLogSnapShot implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'TimeLogSnapShot';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling TimeLogSnapShot., must be bigger than or equal to 1.');
        }
