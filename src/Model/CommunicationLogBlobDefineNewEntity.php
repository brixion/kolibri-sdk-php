...
/**
 * CommunicationLogBlobDefineNewEntity - Brixion Kolibri PHP SDK.
...
/**
 * CommunicationLogBlobDefineNewEntity.
 * @implements \ArrayAccess<string, mixed>
 */
class CommunicationLogBlobDefineNewEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'CommunicationLogBlobDefineNewEntity';
    ...
    */
    ...
    public function setFileName($file_name)
    {
        ...
        if ((mb_strlen($file_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $file_name when calling CommunicationLogBlobDefineNewEntity., must be bigger than or equal to 1.');
        }
    ...
    public function setFileExtension($file_extension)
    {
        ...
        if ((mb_strlen($file_extension) < 1)) {
            throw new \InvalidArgumentException('invalid length for $file_extension when calling CommunicationLogBlobDefineNewEntity., must be bigger than or equal to 1.');
        }
