...
/**
 * CommunicationLogBlob - Brixion Kolibri PHP SDK.
 ...
 */
class CommunicationLogBlob implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'CommunicationLogBlob';
    ...
    protected static $attributeTypes = [
        ...
        'content_id' => 'string',
        '_meta_data' => '\Brixion\Kolibri\Model\CommunicationLogBlobMetaData',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('_meta_data', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['file_extension']) > 255)) {
    ...
    public function setFileExtension($file_extension)
    {
        ...
        if ((mb_strlen($file_extension) > 255)) {
     ...
     * Gets _meta_data
     *
     * @return \Brixion\Kolibri\Model\CommunicationLogBlobMetaData|null
     */
     ...
     * Sets _meta_data
     *
     * @param \Brixion\Kolibri\Model\CommunicationLogBlobMetaData|null $_meta_data _meta_data
     *
     * @return self
     */
    public function setMetaData($_meta_data)
    {
        if (is_null($_meta_data)) {
            throw new \InvalidArgumentException('non-nullable _meta_data cannot be null');
        }
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling CommunicationLogBlob., must be bigger than or equal to 1.');
        }
