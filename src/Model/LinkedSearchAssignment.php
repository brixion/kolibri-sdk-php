...
/**
 * LinkedSearchAssignment - Brixion Kolibri PHP SDK.
 ...
 */
class LinkedSearchAssignment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'LinkedSearchAssignment';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling LinkedSearchAssignment., must be bigger than or equal to 1.');
        }
