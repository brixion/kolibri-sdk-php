...
/**
 * AcquisitionReferenceSettings - Brixion Kolibri PHP SDK.
...
/**
 * AcquisitionReferenceSettings.
 * @implements \ArrayAccess<string, mixed>
 */
class AcquisitionReferenceSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'AcquisitionReferenceSettings';
    ...
    */
    ...
    public function setPrefix($prefix)
    {
        ...
        if ((mb_strlen($prefix) > 50)) {
            throw new \InvalidArgumentException('invalid length for $prefix when calling AcquisitionReferenceSettings., must be smaller than or equal to 50.');
        }
