...
/**
 * MediaContractActivateRequest - Brixion Kolibri PHP SDK.
...
/**
 * MediaContractActivateRequest.
 * @implements \ArrayAccess<string, mixed>
 */
class MediaContractActivateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'MediaContractActivateRequest';
    ...
    */
    ...
    public function setMediaContractId($media_contract_id)
    {
        ...
        if ((mb_strlen($media_contract_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $media_contract_id when calling MediaContractActivateRequest., must be bigger than or equal to 1.');
        }
