...
/**
 * Phrase - Brixion Kolibri PHP SDK.
 ...
 */
class Phrase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'Phrase';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling Phrase., must be bigger than or equal to 1.');
        }
