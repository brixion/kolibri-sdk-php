...
/**
 * DossierItemsDefineNewRequest - Brixion Kolibri PHP SDK.
...
/**
 * DossierItemsDefineNewRequest.
 * @implements \ArrayAccess<string, mixed>
 */
class DossierItemsDefineNewRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'DossierItemsDefineNewRequest';
    ...
    */
     ...
     * Sets parent_id
     *
     * @param string $parent_id The parent id for this Dossier Item. Supported parents: (Object, ObjectType, Project) Assignments, RealEstateAgencies, Employees, Offices, ContactPersons and ContactCompanies.
     *
     * @return self
     */
    public function setParentId($parent_id)
    {
        ...
        if ((mb_strlen($parent_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $parent_id when calling DossierItemsDefineNewRequest., must be bigger than or equal to 1.');
        }
