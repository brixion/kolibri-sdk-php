...
/**
 * RelationGroup - Brixion Kolibri PHP SDK.
 ...
 */
class RelationGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'RelationGroup';
    ...
    protected static $attributeTypes = [
        ...
        'front_color' => 'string',
        'name' => 'string',
        'relation_group_type' => '\Brixion\Kolibri\Model\RelationGroupType',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('relation_group_type', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['relation_group_type'] === null) {
            $invalidProperties[] = "'relation_group_type' can't be null";
        }
     ...
     *
     * @return \Brixion\Kolibri\Model\RelationGroupType
     */
     ...
     *
     * @param \Brixion\Kolibri\Model\RelationGroupType $relation_group_type relation_group_type
     *
     * @return self
     */
    public function setRelationGroupType($relation_group_type)
    {
        if (is_null($relation_group_type)) {
            throw new \InvalidArgumentException('non-nullable relation_group_type cannot be null');
        }
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling RelationGroup., must be bigger than or equal to 1.');
        }
