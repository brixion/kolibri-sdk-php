...
/**
 * BrochureCreateNewLinkRequest - Brixion Kolibri PHP SDK.
...
/**
 * BrochureCreateNewLinkRequest.
 * @implements \ArrayAccess<string, mixed>
 */
class BrochureCreateNewLinkRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'BrochureCreateNewLinkRequest';
    ...
    */
    ...
    public function setObjectAssignmentId($object_assignment_id)
    {
        ...
        if ((mb_strlen($object_assignment_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $object_assignment_id when calling BrochureCreateNewLinkRequest., must be bigger than or equal to 1.');
        }
