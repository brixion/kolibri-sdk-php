...
/**
 * TemplateDefinitionMergeRequest - Brixion Kolibri PHP SDK.
 ...
 */
class TemplateDefinitionMergeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'TemplateDefinitionMergeRequest';
    ...
    {
        $this->setIfExists('template_definition_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['template_definition_id'] === null) {
            $invalidProperties[] = "'template_definition_id' can't be null";
        }
        if ((mb_strlen($this->container['template_definition_id']) < 1)) {
    ...
    {
        if (is_null($template_definition_id)) {
            throw new \InvalidArgumentException('non-nullable template_definition_id cannot be null');
        }

        if ((mb_strlen($template_definition_id) < 1)) {
    ...
    public function setCulture($culture)
    {
        ...
        if ((mb_strlen($culture) > 5)) {
            throw new \InvalidArgumentException('invalid length for $culture when calling TemplateDefinitionMergeRequest., must be smaller than or equal to 5.');
        }
        if ((mb_strlen($culture) < 0)) {
            throw new \InvalidArgumentException('invalid length for $culture when calling TemplateDefinitionMergeRequest., must be bigger than or equal to 0.');
        }
