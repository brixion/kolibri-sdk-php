...
/**
 * BuyAndSaveMunicipality - Brixion Kolibri PHP SDK.
 ...
 */
class BuyAndSaveMunicipality implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'BuyAndSaveMunicipality';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['municipality_id'] === null) {
            $invalidProperties[] = "'municipality_id' can't be null";
        }
     ...
     *
     * @param int $municipality_id In Dutch: \"gemeente code\".
     *
     * @return self
     */
