...
/**
 * GenericAssignmentsDefineNewRequest - Brixion Kolibri PHP SDK.
...
/**
 * GenericAssignmentsDefineNewRequest.
 * @implements \ArrayAccess<string, mixed>
 */
class GenericAssignmentsDefineNewRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'GenericAssignmentsDefineNewRequest';
    ...
    */
     ...
     * Sets employee_ids
     *
     * @param string[] $employee_ids The list of Ids containing the employee this assignment belongs to as its first entry.
     *
     * @return self
     */
    ...
    public function setOfficeId($office_id)
    {
        ...
        if ((mb_strlen($office_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $office_id when calling GenericAssignmentsDefineNewRequest., must be bigger than or equal to 1.');
        }
