...
/**
 * TransactionMetaDataSearchRequest - Brixion Kolibri PHP SDK.
...
/**
 * TransactionMetaDataSearchRequest.
 * @implements \ArrayAccess<string, mixed>
 */
class TransactionMetaDataSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'TransactionMetaDataSearchRequest';
    ...
    protected static $attributeTypes = [
        'order_by' => '\Brixion\Kolibri\Model\TransactionMetaDataOrderByField',
        'ids' => 'string[]',
    ...
    */
     ...
     * Gets order_by
     *
     * @return \Brixion\Kolibri\Model\TransactionMetaDataOrderByField
     */
     ...
     * Sets order_by
     *
     * @param \Brixion\Kolibri\Model\TransactionMetaDataOrderByField $order_by order_by
     *
     * @return self
     */
    ...
    public function setSkip($skip)
    {
        ...
        if (($skip > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling TransactionMetaDataSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($skip < 0)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling TransactionMetaDataSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTake($take)
    {
        ...
        if (($take > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $take when calling TransactionMetaDataSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($take < 0)) {
            throw new \InvalidArgumentException('invalid value for $take when calling TransactionMetaDataSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTerm($term)
    {
        ...
        if ((mb_strlen($term) > 50)) {
            throw new \InvalidArgumentException('invalid length for $term when calling TransactionMetaDataSearchRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($term) < 0)) {
            throw new \InvalidArgumentException('invalid length for $term when calling TransactionMetaDataSearchRequest., must be bigger than or equal to 0.');
        }
