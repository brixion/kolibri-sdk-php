...
/**
 * MapBlob - Brixion Kolibri PHP SDK.
 ...
 */
class MapBlob implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'MapBlob';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('url_big', $data ?? [], null);
        $this->setIfExists('url_medium', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['height'] > 10240)) {
    ...
    public function setHeight($height)
    {
        ...
        if (($height > 10240)) {
            throw new \InvalidArgumentException('invalid value for $height when calling MapBlob., must be smaller than or equal to 10240.');
        }
        if (($height < 0)) {
            throw new \InvalidArgumentException('invalid value for $height when calling MapBlob., must be bigger than or equal to 0.');
        }
     ...
     * Sets url_big
     *
     * @param string|null $url_big url_big
     *
     * @return self
     */
    ...
    {
        if (is_null($url_big)) {
            throw new \InvalidArgumentException('non-nullable url_big cannot be null');
        }
     ...
     * Sets url_medium
     *
     * @param string|null $url_medium url_medium
     *
     * @return self
     */
    public function setUrlMedium($url_medium)
    {
        if (is_null($url_medium)) {
            throw new \InvalidArgumentException('non-nullable url_medium cannot be null');
        }
    ...
    public function setWidth($width)
    {
        ...
        if (($width > 10240)) {
            throw new \InvalidArgumentException('invalid value for $width when calling MapBlob., must be smaller than or equal to 10240.');
        }
        if (($width < 0)) {
            throw new \InvalidArgumentException('invalid value for $width when calling MapBlob., must be bigger than or equal to 0.');
        }
