...
/**
 * PublicationsDeactivateRequest - Brixion Kolibri PHP SDK.
...
/**
 * PublicationsDeactivateRequest.
 * @implements \ArrayAccess<string, mixed>
 */
class PublicationsDeactivateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'PublicationsDeactivateRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['media_partner_id']) < 1)) {
            $invalidProperties[] = "invalid value for 'media_partner_id', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setAssignmentId($assignment_id)
    {
        ...
        if ((mb_strlen($assignment_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $assignment_id when calling PublicationsDeactivateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setMediaPartnerId($media_partner_id)
    {
        ...
        if ((mb_strlen($media_partner_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $media_partner_id when calling PublicationsDeactivateRequest., must be bigger than or equal to 1.');
        }
