...
/**
 * FinancialAdministrationSnapShot - Brixion Kolibri PHP SDK.
 ...
 */
class FinancialAdministrationSnapShot implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'FinancialAdministrationSnapShot';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling FinancialAdministrationSnapShot., must be bigger than or equal to 1.');
        }
