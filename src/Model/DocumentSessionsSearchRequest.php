...
/**
 * DocumentSessionsSearchRequest - Brixion Kolibri PHP SDK.
 ...
 */
class DocumentSessionsSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'DocumentSessionsSearchRequest';
    ...
    protected static $attributeTypes = [
        ...
        'order_by' => '\Brixion\Kolibri\Model\DocumentSessionOrderByField',
        'term_fields' => '\Brixion\Kolibri\Model\DocumentSessionTermField[]',
    ...
    */
     ...
     * Sets parent_id
     *
     * @param string|null $parent_id Search by a specific parent (ObjectAssignment, ContactPerson, ContactCompany) by its id.
     *
     * @return self
     */
     ...
     *
     * @param string|null $document_session_id Search by a specific document session id
     *
     * @return self
     */
     ...
     * Gets order_by
     *
     * @return \Brixion\Kolibri\Model\DocumentSessionOrderByField
     */
     ...
     * Sets order_by
     *
     * @param \Brixion\Kolibri\Model\DocumentSessionOrderByField $order_by Order the results by the indicated company listing field.
     *
     * @return self
     */
     ...
     * Gets term_fields
     *
     * @return \Brixion\Kolibri\Model\DocumentSessionTermField[]|null
     */
     ...
     * Sets term_fields
     *
     * @param \Brixion\Kolibri\Model\DocumentSessionTermField[]|null $term_fields Search for given text (Term) indicated by the fields in the TermFields list. Required in case 'Term' is given.
     *
     * @return self
     */
    ...
    public function setSkip($skip)
    {
        ...
        if (($skip > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling DocumentSessionsSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($skip < 0)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling DocumentSessionsSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTake($take)
    {
        ...
        if (($take > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $take when calling DocumentSessionsSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($take < 0)) {
            throw new \InvalidArgumentException('invalid value for $take when calling DocumentSessionsSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTerm($term)
    {
        ...
        if ((mb_strlen($term) > 50)) {
            throw new \InvalidArgumentException('invalid length for $term when calling DocumentSessionsSearchRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($term) < 0)) {
            throw new \InvalidArgumentException('invalid length for $term when calling DocumentSessionsSearchRequest., must be bigger than or equal to 0.');
        }
