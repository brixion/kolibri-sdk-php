...
/**
 * FinancialAdministrationGroup - Brixion Kolibri PHP SDK.
 ...
 */
class FinancialAdministrationGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'FinancialAdministrationGroup';
    ...
    protected static array $nullables = [
        ...
        'budgeted_number_of_products' => false,
        'id' => false,
        'name' => false,
    ];
    ...
    {
        $this->setIfExists('budgeted_amount', $data ?? [], null);
        $this->setIfExists('budgeted_number_of_products', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($budgeted_amount)) {
            throw new \InvalidArgumentException('non-nullable budgeted_amount cannot be null');
        }
    ...
    {
        if (is_null($budgeted_number_of_products)) {
            throw new \InvalidArgumentException('non-nullable budgeted_number_of_products cannot be null');
        }
