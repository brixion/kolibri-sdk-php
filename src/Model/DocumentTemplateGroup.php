...
/**
 * DocumentTemplateGroup - Brixion Kolibri PHP SDK.
 ...
 */
class DocumentTemplateGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'DocumentTemplateGroup';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling DocumentTemplateGroup., must be bigger than or equal to 1.');
        }
