...
/**
 * DefaultFolderTreeSnapShot - Brixion Kolibri PHP SDK.
 ...
 */
class DefaultFolderTreeSnapShot implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'DefaultFolderTreeSnapShot';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling DefaultFolderTreeSnapShot., must be bigger than or equal to 1.');
        }
