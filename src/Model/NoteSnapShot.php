...
/**
 * NoteSnapShot - Brixion Kolibri PHP SDK.
 ...
 */
class NoteSnapShot implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'NoteSnapShot';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling NoteSnapShot., must be bigger than or equal to 1.');
        }
