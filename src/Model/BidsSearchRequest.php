...
/**
 * BidsSearchRequest - Brixion Kolibri PHP SDK.
 ...
 */
class BidsSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'BidsSearchRequest';
    ...
    protected static $attributeTypes = [
        'order_by' => '\Brixion\Kolibri\Model\BidOrderByField',
        'bid_ids' => 'string[]',
        'assignment_ids' => 'string[]',
        'statuses' => '\Brixion\Kolibri\Model\BidStatus[]',
        'types' => '\Brixion\Kolibri\Model\BidType[]',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('bid_ids', $data ?? [], null);
    ...
    */
     ...
     * Gets order_by
     *
     * @return \Brixion\Kolibri\Model\BidOrderByField
     */
     ...
     * Sets order_by
     *
     * @param \Brixion\Kolibri\Model\BidOrderByField $order_by Order the results by the indicated bid field.
     *
     * @return self
     */
     ...
     * Sets bid_ids
     *
     * @param string[]|null $bid_ids Search by specific bid ids.
     *
     * @return self
     */
    ...
    {
        if (is_null($bid_ids)) {
            throw new \InvalidArgumentException('non-nullable bid_ids cannot be null');
        }
     ...
     * Sets assignment_ids
     *
     * @param string[]|null $assignment_ids Search by specific assignment ids.
     *
     * @return self
     */
     ...
     * Sets statuses
     *
     * @param \Brixion\Kolibri\Model\BidStatus[]|null $statuses Search by bid statuses.
     *
     * @return self
     */
     ...
     * Gets types
     *
     * @return \Brixion\Kolibri\Model\BidType[]|null
     */
     ...
     * Sets types
     *
     * @param \Brixion\Kolibri\Model\BidType[]|null $types Search by bid types.
     *
     * @return self
     */
    ...
    public function setSkip($skip)
    {
        ...
        if (($skip > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling BidsSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($skip < 0)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling BidsSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTake($take)
    {
        ...
        if (($take > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $take when calling BidsSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($take < 0)) {
            throw new \InvalidArgumentException('invalid value for $take when calling BidsSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTerm($term)
    {
        ...
        if ((mb_strlen($term) > 50)) {
            throw new \InvalidArgumentException('invalid length for $term when calling BidsSearchRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($term) < 0)) {
            throw new \InvalidArgumentException('invalid length for $term when calling BidsSearchRequest., must be bigger than or equal to 0.');
        }
