...
/**
 * LinkedTransactionMetaData - Brixion Kolibri PHP SDK.
 ...
 */
class LinkedTransactionMetaData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'LinkedTransactionMetaData';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling LinkedTransactionMetaData., must be bigger than or equal to 1.');
        }
