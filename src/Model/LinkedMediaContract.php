...
/**
 * LinkedMediaContract - Brixion Kolibri PHP SDK.
 ...
 */
class LinkedMediaContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'LinkedMediaContract';
    ...
    protected static $setters = [
        'media_parter_id' => 'setMediaParterId',
    ...
    protected static $getters = [
        'media_parter_id' => 'getMediaParterId',
    ...
    {
        $this->setIfExists('media_parter_id', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets media_parter_id
     *
     * @return string|null
     */
    public function getMediaParterId()
    {
        return $this->container['media_parter_id'];
    }

    /**
     * Sets media_parter_id
     *
     * @param string|null $media_parter_id media_parter_id
     *
     * @return self
     */
    public function setMediaParterId($media_parter_id)
    {
        if (is_null($media_parter_id)) {
            throw new \InvalidArgumentException('non-nullable media_parter_id cannot be null');
        }
        $this->container['media_parter_id'] = $media_parter_id;
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling LinkedMediaContract., must be bigger than or equal to 1.');
        }
