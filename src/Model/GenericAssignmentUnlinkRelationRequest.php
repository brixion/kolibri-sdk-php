...
/**
 * GenericAssignmentUnlinkRelationRequest - Brixion Kolibri PHP SDK.
...
/**
 * GenericAssignmentUnlinkRelationRequest.
 * @implements \ArrayAccess<string, mixed>
 */
class GenericAssignmentUnlinkRelationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'GenericAssignmentUnlinkRelationRequest';
    ...
    */
    ...
    public function setRelationId($relation_id)
    {
        ...
        if ((mb_strlen($relation_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $relation_id when calling GenericAssignmentUnlinkRelationRequest., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string $generic_assignment_id The object assignment to unlink the relation from.
     *
     * @return self
     */
    public function setGenericAssignmentId($generic_assignment_id)
    {
        ...
        if ((mb_strlen($generic_assignment_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $generic_assignment_id when calling GenericAssignmentUnlinkRelationRequest., must be bigger than or equal to 1.');
        }
