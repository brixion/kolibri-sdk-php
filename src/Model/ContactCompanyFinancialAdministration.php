...
/**
 * ContactCompanyFinancialAdministration - Brixion Kolibri PHP SDK.
 ...
 */
class ContactCompanyFinancialAdministration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'ContactCompanyFinancialAdministration';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling ContactCompanyFinancialAdministration., must be bigger than or equal to 1.');
        }
