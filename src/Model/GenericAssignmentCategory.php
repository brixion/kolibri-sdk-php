...
/**
 * GenericAssignmentCategory - Brixion Kolibri PHP SDK.
...
/**
 * GenericAssignmentCategory.
 * @implements \ArrayAccess<string, mixed>
 */
class GenericAssignmentCategory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'GenericAssignmentCategory';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling GenericAssignmentCategory., must be bigger than or equal to 1.');
        }
