...
/**
 * NotesSearchRequest - Brixion Kolibri PHP SDK.
 ...
 */
class NotesSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'NotesSearchRequest';
    ...
    protected static $attributeTypes = [
        'note_id' => 'string',
        'order_by' => '\Brixion\Kolibri\Model\NoteOrderByField',
        'parent_id' => 'string',
        'term_fields' => '\Brixion\Kolibri\Model\NoteTermField[]',
        'is_important' => 'bool',
    ...
    */
     ...
     * Sets note_id
     *
     * @param string|null $note_id Search by a specific note Id. Used to return/refresh one search result.
     *
     * @return self
     */
     ...
     * Gets order_by
     *
     * @return \Brixion\Kolibri\Model\NoteOrderByField
     */
     ...
     * Sets order_by
     *
     * @param \Brixion\Kolibri\Model\NoteOrderByField $order_by Order the results by the indicated note field.
     *
     * @return self
     */
     ...
     * Gets term_fields
     *
     * @return \Brixion\Kolibri\Model\NoteTermField[]|null
     */
     ...
     * Sets term_fields
     *
     * @param \Brixion\Kolibri\Model\NoteTermField[]|null $term_fields Search for given text (Term) indicated by the fields in the TermFields list. Required in case 'Term' is given.
     *
     * @return self
     */
    ...
    public function setSkip($skip)
    {
        ...
        if (($skip > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling NotesSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($skip < 0)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling NotesSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTake($take)
    {
        ...
        if (($take > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $take when calling NotesSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($take < 0)) {
            throw new \InvalidArgumentException('invalid value for $take when calling NotesSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTerm($term)
    {
        ...
        if ((mb_strlen($term) > 50)) {
            throw new \InvalidArgumentException('invalid length for $term when calling NotesSearchRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($term) < 0)) {
            throw new \InvalidArgumentException('invalid length for $term when calling NotesSearchRequest., must be bigger than or equal to 0.');
        }
