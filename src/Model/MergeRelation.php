...
/**
 * MergeRelation - Brixion Kolibri PHP SDK.
 ...
 */
class MergeRelation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'MergeRelation';
    ...
    */
     ...
     * Sets relation_type
     *
     * @param \Brixion\Kolibri\Model\RelationType $relation_type relation_type
     *
     * @return self
     */
