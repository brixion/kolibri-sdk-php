...
/**
 * ContactLinksSearchResponse - Brixion Kolibri PHP SDK.
...
/**
 * ContactLinksSearchResponse.
 * @implements \ArrayAccess<string, mixed>
 */
class ContactLinksSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'ContactLinksSearchResponse';
    ...
    protected static $attributeTypes = [
        'result_count' => 'int',
        'results' => '\Brixion\Kolibri\Model\ContactLinkSnapShot[]',
        'total_results' => 'int',
    ];
    ...
    */
     ...
     * Sets results
     *
     * @param \Brixion\Kolibri\Model\ContactLinkSnapShot[]|null $results results
     *
     * @return self
     */
