...
/**
 * ContactLinksSearchRequest - Brixion Kolibri PHP SDK.
 ...
 */
class ContactLinksSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'ContactLinksSearchRequest';
    ...
    protected static $attributeTypes = [
        'order_by' => '\Brixion\Kolibri\Model\ContactLinkOrderByField',
        'relation_id' => 'string',
        'term_fields' => '\Brixion\Kolibri\Model\ContactLinkTermField[]',
    ...
    */
     ...
     * Gets order_by
     *
     * @return \Brixion\Kolibri\Model\ContactLinkOrderByField
     */
     ...
     * Sets order_by
     *
     * @param \Brixion\Kolibri\Model\ContactLinkOrderByField $order_by Order the results by the indicated ContactLink field.
     *
     * @return self
     */
     ...
     * Gets term_fields
     *
     * @return \Brixion\Kolibri\Model\ContactLinkTermField[]|null
     */
     ...
     * Sets term_fields
     *
     * @param \Brixion\Kolibri\Model\ContactLinkTermField[]|null $term_fields Search for given text (Term) indicated by the fields in the TermFields list. Required in case 'Term' is given.
     *
     * @return self
     */
    ...
    public function setSkip($skip)
    {
        ...
        if (($skip > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling ContactLinksSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($skip < 0)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling ContactLinksSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTake($take)
    {
        ...
        if (($take > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $take when calling ContactLinksSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($take < 0)) {
            throw new \InvalidArgumentException('invalid value for $take when calling ContactLinksSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTerm($term)
    {
        ...
        if ((mb_strlen($term) > 50)) {
            throw new \InvalidArgumentException('invalid length for $term when calling ContactLinksSearchRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($term) < 0)) {
            throw new \InvalidArgumentException('invalid length for $term when calling ContactLinksSearchRequest., must be bigger than or equal to 0.');
        }
