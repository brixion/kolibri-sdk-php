...
/**
 * GeoASublocalitySearchRequest - Brixion Kolibri PHP SDK.
...
/**
 * GeoASublocalitySearchRequest.
 * @implements \ArrayAccess<string, mixed>
 */
class GeoASublocalitySearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'GeoASublocalitySearchRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('locality_id', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['locality_id'] === null) {
            $invalidProperties[] = "'locality_id' can't be null";
        }
    ...
    public function setCulture($culture)
    {
        ...
        if ((mb_strlen($culture) > 5)) {
            throw new \InvalidArgumentException('invalid length for $culture when calling GeoASublocalitySearchRequest., must be smaller than or equal to 5.');
        }
        if ((mb_strlen($culture) < 0)) {
            throw new \InvalidArgumentException('invalid length for $culture when calling GeoASublocalitySearchRequest., must be bigger than or equal to 0.');
        }
     ...
     * Sets locality_id
     *
     * @param int $locality_id locality_id
     *
     * @return self
     */
    public function setLocalityId($locality_id)
    {
        if (is_null($locality_id)) {
            throw new \InvalidArgumentException('non-nullable locality_id cannot be null');
        }
