...
/**
 * PublicationsActivateRequest - Brixion Kolibri PHP SDK.
...
/**
 * PublicationsActivateRequest.
 * @implements \ArrayAccess<string, mixed>
 */
class PublicationsActivateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'PublicationsActivateRequest';
    ...
    */
    ...
    public function setAssignmentId($assignment_id)
    {
        ...
        if ((mb_strlen($assignment_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $assignment_id when calling PublicationsActivateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setMediaPartnerId($media_partner_id)
    {
        ...
        if ((mb_strlen($media_partner_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $media_partner_id when calling PublicationsActivateRequest., must be bigger than or equal to 1.');
        }
