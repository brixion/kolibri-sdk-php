...
/**
 * BagAddress - Brixion Kolibri PHP SDK.
 ...
 */
class BagAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'BagAddress';
    ...
    protected static $attributeTypes = [
        'house_number_addendum' => 'string',
        'house_letter' => 'string',
        'house_number_display_name' => 'string',
        'use_bag_address' => 'bool',
    ...
    protected static $attributeFormats = [
        'house_number_addendum' => null,
        'house_letter' => null,
        'house_number_display_name' => null,
        'use_bag_address' => null,
    ...
    protected static array $nullables = [
        'house_number_addendum' => false,
        'house_letter' => false,
        'house_number_display_name' => false,
        'use_bag_address' => false,
    ...
    protected static $attributeMap = [
        'house_number_addendum' => 'houseNumberAddendum',
        'house_letter' => 'houseLetter',
        'house_number_display_name' => 'houseNumberDisplayName',
        'use_bag_address' => 'useBagAddress',
    ...
    protected static $setters = [
        'house_number_addendum' => 'setHouseNumberAddendum',
        'house_letter' => 'setHouseLetter',
        'house_number_display_name' => 'setHouseNumberDisplayName',
        'use_bag_address' => 'setUseBagAddress',
    ...
    protected static $getters = [
        'house_number_addendum' => 'getHouseNumberAddendum',
        'house_letter' => 'getHouseLetter',
        'house_number_display_name' => 'getHouseNumberDisplayName',
        'use_bag_address' => 'getUseBagAddress',
    ...
    {
        $this->setIfExists('house_number_addendum', $data ?? [], null);
        $this->setIfExists('house_letter', $data ?? [], null);
        $this->setIfExists('house_number_display_name', $data ?? [], null);
        $this->setIfExists('use_bag_address', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['house_number_addendum']) && (mb_strlen($this->container['house_number_addendum']) > 4)) {
            $invalidProperties[] = "invalid value for 'house_number_addendum', the character length must be smaller than or equal to 4.";
        }

        if (!is_null($this->container['house_letter']) && (mb_strlen($this->container['house_letter']) > 1)) {
            $invalidProperties[] = "invalid value for 'house_letter', the character length must be smaller than or equal to 1.";
        }

        if (!is_null($this->container['house_number_display_name']) && (mb_strlen($this->container['house_number_display_name']) > 7)) {
            $invalidProperties[] = "invalid value for 'house_number_display_name', the character length must be smaller than or equal to 7.";
        }
    ...
    /**
     * Gets house_number_addendum
     *
     * @return string|null
     */
    public function getHouseNumberAddendum()
    {
        return $this->container['house_number_addendum'];
    }

    /**
     * Sets house_number_addendum
     *
     * @param string|null $house_number_addendum house_number_addendum
     *
     * @return self
     */
    public function setHouseNumberAddendum($house_number_addendum)
    {
        if (is_null($house_number_addendum)) {
            throw new \InvalidArgumentException('non-nullable house_number_addendum cannot be null');
        }
        if ((mb_strlen($house_number_addendum) > 4)) {
            throw new \InvalidArgumentException('invalid length for $house_number_addendum when calling BagAddress., must be smaller than or equal to 4.');
        }

        $this->container['house_number_addendum'] = $house_number_addendum;
    ...
    {
        return $this->container['house_letter'];
    }

    /**
     * Sets house_letter
     *
     * @param string|null $house_letter house_letter
     *
     * @return self
     */
    public function setHouseLetter($house_letter)
    {
        if (is_null($house_letter)) {
            throw new \InvalidArgumentException('non-nullable house_letter cannot be null');
        }
        if ((mb_strlen($house_letter) > 1)) {
            throw new \InvalidArgumentException('invalid length for $house_letter when calling BagAddress., must be smaller than or equal to 1.');
        }

        $this->container['house_letter'] = $house_letter;

        return $this;
    }

    /**
     * Gets house_number_display_name
     *
     * @return string|null
     */
    public function getHouseNumberDisplayName()
    {
        return $this->container['house_number_display_name'];
    }

    /**
     * Sets house_number_display_name
     *
     * @param string|null $house_number_display_name house_number_display_name
     *
     * @return self
     */
    public function setHouseNumberDisplayName($house_number_display_name)
    {
        if (is_null($house_number_display_name)) {
            throw new \InvalidArgumentException('non-nullable house_number_display_name cannot be null');
        }
        if ((mb_strlen($house_number_display_name) > 7)) {
            throw new \InvalidArgumentException('invalid length for $house_number_display_name when calling BagAddress., must be smaller than or equal to 7.');
        }

        $this->container['house_number_display_name'] = $house_number_display_name;

        return $this;
    }

    /**
     * Gets use_bag_address
     *
     * @return bool|null
     */
    public function getUseBagAddress()
    {
        return $this->container['use_bag_address'];
    }

    /**
     * Sets use_bag_address
     *
     * @param bool|null $use_bag_address If set to true, a couple of things happen. When saving an address with this value true: - Map the values for House Letter and House number addendum also to the HouseNumberPostfix in a {HouseLetter}{HouseNumberAddendum} way. (any value for HouseNumberPostfix is ignored) If set to false, or set to null - Do an educated guess on the value in HouseNumberPostfix to also store the values in HouseLetter and HouseNumberAddendum - Save the provided value in HouseNumberPostfix              When getting data it does not really matter. Both the HouseNumberAddendum, HouseLetter and the HouseNumberPostfix values are provided.
     *
     * @return self
     */
    public function setUseBagAddress($use_bag_address)
    {
        if (is_null($use_bag_address)) {
            throw new \InvalidArgumentException('non-nullable use_bag_address cannot be null');
        }
        $this->container['use_bag_address'] = $use_bag_address;
