...
/**
 * CompanyListingsSearchRequest - Brixion Kolibri PHP SDK.
 ...
 */
class CompanyListingsSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'CompanyListingsSearchRequest';
    ...
    protected static $attributeTypes = [
        ...
        'order_by' => '\Brixion\Kolibri\Model\CompanyListingOrderByField',
        'term_fields' => 'string[]',
    ...
    */
     ...
     * Sets cadastre_id
     *
     * @param string|null $cadastre_id Search by a specific company listing Id. Used to return/refresh one search result.
     *
     * @return self
     */
     ...
     * Gets order_by
     *
     * @return \Brixion\Kolibri\Model\CompanyListingOrderByField
     */
     ...
     * Sets order_by
     *
     * @param \Brixion\Kolibri\Model\CompanyListingOrderByField $order_by Order the results by the indicated company listing field.
     *
     * @return self
     */
     ...
     * Sets term_fields
     *
     * @param string[]|null $term_fields Search for given text (Term) indicated by the fields in the TermFields list. Required in case 'Term' is given.
     *
     * @return self
     */
    ...
    public function setSkip($skip)
    {
        ...
        if (($skip > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling CompanyListingsSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($skip < 0)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling CompanyListingsSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTake($take)
    {
        ...
        if (($take > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $take when calling CompanyListingsSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($take < 0)) {
            throw new \InvalidArgumentException('invalid value for $take when calling CompanyListingsSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTerm($term)
    {
        ...
        if ((mb_strlen($term) > 50)) {
            throw new \InvalidArgumentException('invalid length for $term when calling CompanyListingsSearchRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($term) < 0)) {
            throw new \InvalidArgumentException('invalid length for $term when calling CompanyListingsSearchRequest., must be bigger than or equal to 0.');
        }
