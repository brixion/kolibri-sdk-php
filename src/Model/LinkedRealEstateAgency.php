...
/**
 * LinkedRealEstateAgency - Brixion Kolibri PHP SDK.
...
/**
 * LinkedRealEstateAgency.
 * @implements \ArrayAccess<string, mixed>
 */
class LinkedRealEstateAgency implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'LinkedRealEstateAgency';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling LinkedRealEstateAgency., must be bigger than or equal to 1.');
        }
