...
/**
 * FolderTreeSnapShot - Brixion Kolibri PHP SDK.
 ...
 */
class FolderTreeSnapShot implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'FolderTreeSnapShot';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling FolderTreeSnapShot., must be bigger than or equal to 1.');
        }
