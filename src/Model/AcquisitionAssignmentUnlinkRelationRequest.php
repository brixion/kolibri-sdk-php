...
/**
 * AcquisitionAssignmentUnlinkRelationRequest - Brixion Kolibri PHP SDK.
...
/**
 * AcquisitionAssignmentUnlinkRelationRequest.
 * @implements \ArrayAccess<string, mixed>
 */
class AcquisitionAssignmentUnlinkRelationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'AcquisitionAssignmentUnlinkRelationRequest';
    ...
    */
    ...
    public function setRelationId($relation_id)
    {
        ...
        if ((mb_strlen($relation_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $relation_id when calling AcquisitionAssignmentUnlinkRelationRequest., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string $acquisition_assignment_id The object assignment to unlink the relation from.
     *
     * @return self
     */
    public function setAcquisitionAssignmentId($acquisition_assignment_id)
    {
        ...
        if ((mb_strlen($acquisition_assignment_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $acquisition_assignment_id when calling AcquisitionAssignmentUnlinkRelationRequest., must be bigger than or equal to 1.');
        }
