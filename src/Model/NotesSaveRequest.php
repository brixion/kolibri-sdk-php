...
/**
 * NotesSaveRequest - Brixion Kolibri PHP SDK.
 ...
 */
class NotesSaveRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'NotesSaveRequest';
    ...
    */
     ...
     * Sets description
     *
     * @param string|null $description Note description.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id Id of Note. Set to null to create a new note.
     *
     * @return self
     */
