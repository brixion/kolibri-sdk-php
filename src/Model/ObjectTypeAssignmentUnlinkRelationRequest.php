...
/**
 * ObjectTypeAssignmentUnlinkRelationRequest - Brixion Kolibri PHP SDK.
...
/**
 * ObjectTypeAssignmentUnlinkRelationRequest.
 * @implements \ArrayAccess<string, mixed>
 */
class ObjectTypeAssignmentUnlinkRelationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'ObjectTypeAssignmentUnlinkRelationRequest';
    ...
    */
    ...
    public function setRelationId($relation_id)
    {
        ...
        if ((mb_strlen($relation_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $relation_id when calling ObjectTypeAssignmentUnlinkRelationRequest., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string $object_type_assignment_id The object type assignment to unlink the relation from.
     *
     * @return self
     */
    public function setObjectTypeAssignmentId($object_type_assignment_id)
    {
        ...
        if ((mb_strlen($object_type_assignment_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $object_type_assignment_id when calling ObjectTypeAssignmentUnlinkRelationRequest., must be bigger than or equal to 1.');
        }
