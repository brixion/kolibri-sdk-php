...
/**
 * UpdateAvailabilityWithdrawnSettings - Brixion Kolibri PHP SDK.
 ...
 */
class UpdateAvailabilityWithdrawnSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'UpdateAvailabilityWithdrawnSettings';
    ...
    */
     ...
     *
     * @param \Brixion\Kolibri\Model\WithdrawReason $withdraw_reason withdraw_reason
     *
     * @return self
     */
