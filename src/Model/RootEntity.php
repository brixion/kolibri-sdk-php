...
/**
 * RootEntity - Brixion Kolibri PHP SDK.
 ...
 */
class RootEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'RootEntity';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling RootEntity., must be bigger than or equal to 1.');
        }
