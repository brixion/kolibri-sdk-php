...
/**
 * GenericAssignmentCategorySnapshot - Brixion Kolibri PHP SDK.
...
/**
 * GenericAssignmentCategorySnapshot.
 * @implements \ArrayAccess<string, mixed>
 */
class GenericAssignmentCategorySnapshot implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'GenericAssignmentCategorySnapshot';
    ...
    protected static $attributeTypes = [
        'title' => 'string',
        'category_type' => '\Brixion\Kolibri\Model\GenericAssignmentCategoryType',
    ...
    */
     ...
     * Sets category_type
     *
     * @param \Brixion\Kolibri\Model\GenericAssignmentCategoryType|null $category_type category_type
     *
     * @return self
     */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling GenericAssignmentCategorySnapshot., must be bigger than or equal to 1.');
        }
