...
/**
 * RelationGroupSnapShot - Brixion Kolibri PHP SDK.
 ...
 */
class RelationGroupSnapShot implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'RelationGroupSnapShot';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling RelationGroupSnapShot., must be bigger than or equal to 1.');
        }
