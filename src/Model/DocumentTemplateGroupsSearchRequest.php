...
/**
 * DocumentTemplateGroupsSearchRequest - Brixion Kolibri PHP SDK.
...
/**
 * DocumentTemplateGroupsSearchRequest.
 * @implements \ArrayAccess<string, mixed>
 */
class DocumentTemplateGroupsSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'DocumentTemplateGroupsSearchRequest';
    ...
    */
    ...
    public function setSkip($skip)
    {
        ...
        if (($skip > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling DocumentTemplateGroupsSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($skip < 0)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling DocumentTemplateGroupsSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTake($take)
    {
        ...
        if (($take > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $take when calling DocumentTemplateGroupsSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($take < 0)) {
            throw new \InvalidArgumentException('invalid value for $take when calling DocumentTemplateGroupsSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTerm($term)
    {
        ...
        if ((mb_strlen($term) > 50)) {
            throw new \InvalidArgumentException('invalid length for $term when calling DocumentTemplateGroupsSearchRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($term) < 0)) {
            throw new \InvalidArgumentException('invalid length for $term when calling DocumentTemplateGroupsSearchRequest., must be bigger than or equal to 0.');
        }
