...
/**
 * TimeLogsSearchRequest - Brixion Kolibri PHP SDK.
...
/**
 * TimeLogsSearchRequest.
 * @implements \ArrayAccess<string, mixed>
 */
class TimeLogsSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'TimeLogsSearchRequest';
    ...
    protected static $attributeTypes = [
        'order_by' => '\Brixion\Kolibri\Model\TimeLogOrderByField',
        'term_fields' => '\Brixion\Kolibri\Model\TimeLogTermField[]',
        'time_log_ids' => 'string[]',
        'employee_ids' => 'string[]',
        'assignment_ids' => 'string[]',
        'contact_person_ids' => 'string[]',
        'contact_company_ids' => 'string[]',
    ...
    protected static array $nullables = [
        ...
        'contact_person_ids' => false,
        'contact_company_ids' => false,
    ...
    protected static $attributeMap = [
        ...
        'contact_company_ids' => 'contactCompanyIds',
    ...
    protected static $setters = [
        ...
        'time_log_ids' => 'setTimeLogIds',
        'employee_ids' => 'setEmployeeIds',
        'assignment_ids' => 'setAssignmentIds',
        'contact_person_ids' => 'setContactPersonIds',
        'contact_company_ids' => 'setContactCompanyIds',
    ...
    protected static $getters = [
        ...
        'time_log_ids' => 'getTimeLogIds',
        'employee_ids' => 'getEmployeeIds',
        'assignment_ids' => 'getAssignmentIds',
        'contact_person_ids' => 'getContactPersonIds',
        'contact_company_ids' => 'getContactCompanyIds',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('time_log_ids', $data ?? [], null);
        $this->setIfExists('employee_ids', $data ?? [], null);
        $this->setIfExists('assignment_ids', $data ?? [], null);
        $this->setIfExists('contact_person_ids', $data ?? [], null);
        $this->setIfExists('contact_company_ids', $data ?? [], null);
    ...
    */
     ...
     * Gets order_by
     *
     * @return \Brixion\Kolibri\Model\TimeLogOrderByField
     */
     ...
     * Sets order_by
     *
     * @param \Brixion\Kolibri\Model\TimeLogOrderByField $order_by Order the results by the indicated timeLog field.
     *
     * @return self
     */
     ...
     * Gets term_fields
     *
     * @return \Brixion\Kolibri\Model\TimeLogTermField[]|null
     */
     ...
     * Sets term_fields
     *
     * @param \Brixion\Kolibri\Model\TimeLogTermField[]|null $term_fields Search for given text (Term) indicated by the fields in the TermFields list. Required in case 'Term' is given.
     *
     * @return self
     */
     ...
     * @return string[]|null
     */
    public function getTimeLogIds()
    {
        return $this->container['time_log_ids'];
    }

    /**
     * Sets time_log_ids
     *
     * @param string[]|null $time_log_ids Search by specific timeLog ids.
     *
     * @return self
     */
    public function setTimeLogIds($time_log_ids)
    {
        if (is_null($time_log_ids)) {
            throw new \InvalidArgumentException('non-nullable time_log_ids cannot be null');
        }
        $this->container['time_log_ids'] = $time_log_ids;
     ...
     * Sets assignment_ids
     *
     * @param string[]|null $assignment_ids Search the tasks assigned and/or created by given assignment ids.
     *
     * @return self
     */
    ...
    /**
     * Gets contact_person_ids
     *
     * @return string[]|null
     */
    public function getContactPersonIds()
    {
        return $this->container['contact_person_ids'];
    }

    /**
     * Sets contact_person_ids
     *
     * @param string[]|null $contact_person_ids Search the tasks assigned and/or created by given contactPerson ids.
     *
     * @return self
     */
    public function setContactPersonIds($contact_person_ids)
    {
        if (is_null($contact_person_ids)) {
            throw new \InvalidArgumentException('non-nullable contact_person_ids cannot be null');
        }
        $this->container['contact_person_ids'] = $contact_person_ids;

        return $this;
    }

    /**
     * Gets contact_company_ids
     *
     * @return string[]|null
     */
    public function getContactCompanyIds()
    {
        return $this->container['contact_company_ids'];
    }

    /**
     * Sets contact_company_ids
     *
     * @param string[]|null $contact_company_ids Search the tasks assigned and/or created by given contactCompany ids.
     *
     * @return self
     */
    public function setContactCompanyIds($contact_company_ids)
    {
        if (is_null($contact_company_ids)) {
            throw new \InvalidArgumentException('non-nullable contact_company_ids cannot be null');
        }
        $this->container['contact_company_ids'] = $contact_company_ids;
    ...
    public function setSkip($skip)
    {
        ...
        if (($skip > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling TimeLogsSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($skip < 0)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling TimeLogsSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTake($take)
    {
        ...
        if (($take > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $take when calling TimeLogsSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($take < 0)) {
            throw new \InvalidArgumentException('invalid value for $take when calling TimeLogsSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTerm($term)
    {
        ...
        if ((mb_strlen($term) > 50)) {
            throw new \InvalidArgumentException('invalid length for $term when calling TimeLogsSearchRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($term) < 0)) {
            throw new \InvalidArgumentException('invalid length for $term when calling TimeLogsSearchRequest., must be bigger than or equal to 0.');
        }
