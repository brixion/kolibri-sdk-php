...
/**
 * DossierItemsSearchRequest - Brixion Kolibri PHP SDK.
 ...
 */
class DossierItemsSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'DossierItemsSearchRequest';
    ...
    protected static $attributeTypes = [
        'order_by' => '\Brixion\Kolibri\Model\DossierItemOrderByField',
        'parent_id' => 'string',
        'parent_ids' => 'string[]',
        'id' => 'string',
        'ids' => 'string[]',
        'term_fields' => '\Brixion\Kolibri\Model\DossierItemTermField[]',
    ...
    */
     ...
     * Gets order_by
     *
     * @return \Brixion\Kolibri\Model\DossierItemOrderByField
     */
     ...
     * Sets order_by
     *
     * @param \Brixion\Kolibri\Model\DossierItemOrderByField $order_by Order the results by the indicated note field.
     *
     * @return self
     */
     ...
     * Sets parent_id
     *
     * @param string|null $parent_id Search by a specific parent Id. Obsolete: will be removed in future version; use 'parentIds' parameter in stead.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id Search by a specific dossier item Id. Obsolete: will be removed in future version; use 'ids' parameter in stead.
     *
     * @return self
     */
     ...
     * Sets ids
     *
     * @param string[]|null $ids Search by one or more dossier item Ids.
     *
     * @return self
     */
     ...
     * Gets term_fields
     *
     * @return \Brixion\Kolibri\Model\DossierItemTermField[]|null
     */
     ...
     * Sets term_fields
     *
     * @param \Brixion\Kolibri\Model\DossierItemTermField[]|null $term_fields Search for given text (Term) indicated by the fields in the TermFields list. Required in case 'Term' is given.
     *
     * @return self
     */
     ...
     *
     * @param \Brixion\Kolibri\Model\DossierItemType[]|null $dossier_item_type Search by one or more dossier item types.
     *
     * @return self
     */
    ...
    public function setSkip($skip)
    {
        ...
        if (($skip > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling DossierItemsSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($skip < 0)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling DossierItemsSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTake($take)
    {
        ...
        if (($take > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $take when calling DossierItemsSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($take < 0)) {
            throw new \InvalidArgumentException('invalid value for $take when calling DossierItemsSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTerm($term)
    {
        ...
        if ((mb_strlen($term) > 50)) {
            throw new \InvalidArgumentException('invalid length for $term when calling DossierItemsSearchRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($term) < 0)) {
            throw new \InvalidArgumentException('invalid length for $term when calling DossierItemsSearchRequest., must be bigger than or equal to 0.');
        }
