...
/**
 * TemplateDefinitionCategorySnapShot - Brixion Kolibri PHP SDK.
 ...
 */
class TemplateDefinitionCategorySnapShot implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'TemplateDefinitionCategorySnapShot';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling TemplateDefinitionCategorySnapShot., must be bigger than or equal to 1.');
        }
