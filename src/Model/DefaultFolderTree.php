...
/**
 * DefaultFolderTree - Brixion Kolibri PHP SDK.
 ...
 */
class DefaultFolderTree implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'DefaultFolderTree';
    ...
    protected static $attributeTypes = [
        ...
        'root_folder_tree' => '\Brixion\Kolibri\Model\DefaultFolderTreeRootFolderEntity',
    ...
    */
     ...
     *
     * @return \Brixion\Kolibri\Model\DefaultFolderTreeRootFolderEntity|null
     */
     ...
     *
     * @param \Brixion\Kolibri\Model\DefaultFolderTreeRootFolderEntity|null $root_folder_tree root_folder_tree
     *
     * @return self
     */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling DefaultFolderTree., must be bigger than or equal to 1.');
        }
