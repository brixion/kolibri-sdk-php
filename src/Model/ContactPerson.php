...
/**
 * ContactPerson - Brixion Kolibri PHP SDK.
...
class ContactPerson implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'ContactPerson';
    ...
    protected static $attributeTypes = [
        'culture' => 'string',
        'contact_types' => '\Brixion\Kolibri\Model\ContactType[]',
        'keep_addresses_in_sync' => 'bool',
        'future_address' => '\Brixion\Kolibri\Model\Address',
        'future_address_activation_date_time' => '\DateTime',
        'linked_administrations' => '\Brixion\Kolibri\Model\ContactPersonFinancialAdministration[]',
        'linked_partner' => '\Brixion\Kolibri\Model\ContactPersonPartner',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('keep_addresses_in_sync', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['keep_addresses_in_sync'] === null) {
            $invalidProperties[] = "'keep_addresses_in_sync' can't be null";
        }
     ...
     * Sets culture
     *
     * @param string|null $culture The prefered culture of this contact person in the format languagecode2-country/regioncode2.
     *
     * @return self
     */
     ...
     * Gets contact_types
     *
     * @return \Brixion\Kolibri\Model\ContactType[]|null
     */
     ...
     * Sets contact_types
     *
     * @param \Brixion\Kolibri\Model\ContactType[]|null $contact_types contact_types
     *
     * @return self
     */
    ...
    {
        if (is_null($keep_addresses_in_sync)) {
            throw new \InvalidArgumentException('non-nullable keep_addresses_in_sync cannot be null');
        }
     ...
     *
     * @return \Brixion\Kolibri\Model\ContactPersonFinancialAdministration[]|null
     */
     ...
     *
     * @param \Brixion\Kolibri\Model\ContactPersonFinancialAdministration[]|null $linked_administrations linked_administrations
     *
     * @return self
     */
     ...
     * Gets linked_partner
     *
     * @return \Brixion\Kolibri\Model\ContactPersonPartner|null
     */
     ...
     * Sets linked_partner
     *
     * @param \Brixion\Kolibri\Model\ContactPersonPartner|null $linked_partner linked_partner
     *
     * @return self
     */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling ContactPerson., must be bigger than or equal to 1.');
        }
