...
/**
 * RelationGroupsLinkRequest - Brixion Kolibri PHP SDK.
...
/**
 * RelationGroupsLinkRequest.
 * @implements \ArrayAccess<string, mixed>
 */
class RelationGroupsLinkRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'RelationGroupsLinkRequest';
    ...
    */
    ...
    public function setRelationGroupId($relation_group_id)
    {
        ...
        if ((mb_strlen($relation_group_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $relation_group_id when calling RelationGroupsLinkRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setRelationId($relation_id)
    {
        ...
        if ((mb_strlen($relation_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $relation_id when calling RelationGroupsLinkRequest., must be bigger than or equal to 1.');
        }
