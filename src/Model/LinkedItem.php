...
/**
 * LinkedItem - Brixion Kolibri PHP SDK.
 ...
 */
class LinkedItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'LinkedItem';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling LinkedItem., must be bigger than or equal to 1.');
        }
