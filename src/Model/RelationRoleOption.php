...
/**
 * RelationRoleOption - Brixion Kolibri PHP SDK.
 ...
 */
class RelationRoleOption implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'RelationRoleOption';
    ...
    protected static $attributeTypes = [
        'assignment_types' => '\Brixion\Kolibri\Model\AssignmentType[]',
        'display_name_for_rent' => 'string',
        'display_name_for_sale' => 'string',
        'display_name' => 'string',
        'id' => 'int',
        'value' => '\Brixion\Kolibri\Model\RelationRole',
    ];
    ...
    */
     ...
     *
     * @param \Brixion\Kolibri\Model\AssignmentType[]|null $assignment_types assignment_types
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param \Brixion\Kolibri\Model\RelationRole $value value
     *
     * @return self
     */
