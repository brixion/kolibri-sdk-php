...
/**
 * BusinessPartnersSearchRequest - Brixion Kolibri PHP SDK.
...
/**
 * BusinessPartnersSearchRequest.
 * @implements \ArrayAccess<string, mixed>
 */
class BusinessPartnersSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'BusinessPartnersSearchRequest';
    ...
    protected static $attributeTypes = [
        'order_by' => '\Brixion\Kolibri\Model\BusinessPartnerOrderByField',
        'term_fields' => '\Brixion\Kolibri\Model\BusinessPartnerTermField[]',
    ...
    */
     ...
     * Gets order_by
     *
     * @return \Brixion\Kolibri\Model\BusinessPartnerOrderByField
     */
     ...
     * Sets order_by
     *
     * @param \Brixion\Kolibri\Model\BusinessPartnerOrderByField $order_by Order the results by the indicated BusinessPartner field.
     *
     * @return self
     */
     ...
     * Gets term_fields
     *
     * @return \Brixion\Kolibri\Model\BusinessPartnerTermField[]|null
     */
     ...
     * Sets term_fields
     *
     * @param \Brixion\Kolibri\Model\BusinessPartnerTermField[]|null $term_fields Search for given text (Term) indicated by the fields in the TermFields list. Required in case 'Term' is given.
     *
     * @return self
     */
    ...
    public function setSkip($skip)
    {
        ...
        if (($skip > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling BusinessPartnersSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($skip < 0)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling BusinessPartnersSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTake($take)
    {
        ...
        if (($take > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $take when calling BusinessPartnersSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($take < 0)) {
            throw new \InvalidArgumentException('invalid value for $take when calling BusinessPartnersSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTerm($term)
    {
        ...
        if ((mb_strlen($term) > 50)) {
            throw new \InvalidArgumentException('invalid length for $term when calling BusinessPartnersSearchRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($term) < 0)) {
            throw new \InvalidArgumentException('invalid length for $term when calling BusinessPartnersSearchRequest., must be bigger than or equal to 0.');
        }
