...
/**
 * ObjectAssignmentsUpdateAvailabilityRequest - Brixion Kolibri PHP SDK.
 ...
 */
class ObjectAssignmentsUpdateAvailabilityRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'ObjectAssignmentsUpdateAvailabilityRequest';
    ...
    protected static $attributeTypes = [
        'available_settings' => '\Brixion\Kolibri\Model\UpdateAvailabilityAvailableSettings',
        'hide_on_funda_until' => '\DateTime',
        'id' => 'string',
        'rented_settings' => '\Brixion\Kolibri\Model\UpdateAvailabilityRentedSettings',
        'sold_settings' => '\Brixion\Kolibri\Model\UpdateAvailabilitySoldSettings',
        'update_availability_action' => '\Brixion\Kolibri\Model\UpdateAvailabilityAction',
        'withdrawn_settings' => '\Brixion\Kolibri\Model\UpdateAvailabilityWithdrawnSettings',
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('withdrawn_settings', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @return \Brixion\Kolibri\Model\UpdateAvailabilityAvailableSettings|null
     */
     ...
     *
     * @param \Brixion\Kolibri\Model\UpdateAvailabilityAvailableSettings|null $available_settings AvailableSettings is required when UpdateAvailabilityAction = ToAvailable.
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $hide_on_funda_until Publish this assignment to Tiara, but hide it for Funda for a while. Only used when UpdateAvailabilityAction is 'ToAvailable'. Ignored for all other UpdateAvailabilityAction.
     *
     * @return self
     */
     ...
     *
     * @return \Brixion\Kolibri\Model\UpdateAvailabilityRentedSettings|null
     */
     ...
     *
     * @param \Brixion\Kolibri\Model\UpdateAvailabilityRentedSettings|null $rented_settings RentedSettings is required when UpdateAvailabilityAction = ToRented
     *
     * @return self
     */
     ...
     * Gets sold_settings
     *
     * @return \Brixion\Kolibri\Model\UpdateAvailabilitySoldSettings|null
     */
     ...
     * Sets sold_settings
     *
     * @param \Brixion\Kolibri\Model\UpdateAvailabilitySoldSettings|null $sold_settings SoldSettings is required when UpdateAvailabilityAction = ToSold
     *
     * @return self
     */
     ...
     *
     * @return \Brixion\Kolibri\Model\UpdateAvailabilityWithdrawnSettings|null
     */
     ...
     *
     * @param \Brixion\Kolibri\Model\UpdateAvailabilityWithdrawnSettings|null $withdrawn_settings WithdrawnSettings is required when UpdateAvailabilityAction = ToWithdrawn
     *
     * @return self
     */
    public function setWithdrawnSettings($withdrawn_settings)
    {
        if (is_null($withdrawn_settings)) {
            throw new \InvalidArgumentException('non-nullable withdrawn_settings cannot be null');
        }
