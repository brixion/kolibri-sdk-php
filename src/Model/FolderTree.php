...
/**
 * FolderTree - Brixion Kolibri PHP SDK.
 ...
 */
class FolderTree implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'FolderTree';
    ...
    protected static $attributeTypes = [
        'parent_id' => 'string',
        'root_folder_tree' => '\Brixion\Kolibri\Model\FolderTreeRootFolderEntity',
    ...
    protected static $attributeMap = [
        'parent_id' => 'parentId',
        'root_folder_tree' => 'rootFolderTree',
    ...
    protected static $setters = [
        ...
        'root_folder_tree' => 'setRootFolderTree',
    ...
    protected static $getters = [
        ...
        'root_folder_tree' => 'getRootFolderTree',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('root_folder_tree', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets root_folder_tree
     *
     * @return \Brixion\Kolibri\Model\FolderTreeRootFolderEntity|null
     */
    public function getRootFolderTree()
    {
        return $this->container['root_folder_tree'];
    }

    /**
     * Sets root_folder_tree
     *
     * @param \Brixion\Kolibri\Model\FolderTreeRootFolderEntity|null $root_folder_tree root_folder_tree
     *
     * @return self
     */
    public function setRootFolderTree($root_folder_tree)
    {
        if (is_null($root_folder_tree)) {
            throw new \InvalidArgumentException('non-nullable root_folder_tree cannot be null');
        }
        $this->container['root_folder_tree'] = $root_folder_tree;
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling FolderTree., must be bigger than or equal to 1.');
        }
