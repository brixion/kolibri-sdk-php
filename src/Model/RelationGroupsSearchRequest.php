...
/**
 * RelationGroupsSearchRequest - Brixion Kolibri PHP SDK.
 ...
 */
class RelationGroupsSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'RelationGroupsSearchRequest';
    ...
    protected static $attributeTypes = [
        ...
        'order_by' => '\Brixion\Kolibri\Model\RelationGroupOrderByField',
        'relation_group_id' => 'string',
        'term_fields' => '\Brixion\Kolibri\Model\RelationGroupTermField[]',
    ...
    */
     ...
     *
     * @param bool $include_statistics Return statistics, like number of relations per relation group.
     *
     * @return self
     */
     ...
     * Gets order_by
     *
     * @return \Brixion\Kolibri\Model\RelationGroupOrderByField
     */
     ...
     * Sets order_by
     *
     * @param \Brixion\Kolibri\Model\RelationGroupOrderByField $order_by Order the results by the indicated RelationGroup field.
     *
     * @return self
     */
     ...
     *
     * @param string|null $relation_group_id Search by a specific relationGroup Id. Used to return/refresh one search result.
     *
     * @return self
     */
     ...
     * Gets term_fields
     *
     * @return \Brixion\Kolibri\Model\RelationGroupTermField[]|null
     */
     ...
     * Sets term_fields
     *
     * @param \Brixion\Kolibri\Model\RelationGroupTermField[]|null $term_fields Search for given text (Term) indicated by the fields in the TermFields list. Required in case 'Term' is given.
     *
     * @return self
     */
    ...
    public function setSkip($skip)
    {
        ...
        if (($skip > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling RelationGroupsSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($skip < 0)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling RelationGroupsSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTake($take)
    {
        ...
        if (($take > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $take when calling RelationGroupsSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($take < 0)) {
            throw new \InvalidArgumentException('invalid value for $take when calling RelationGroupsSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTerm($term)
    {
        ...
        if ((mb_strlen($term) > 50)) {
            throw new \InvalidArgumentException('invalid length for $term when calling RelationGroupsSearchRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($term) < 0)) {
            throw new \InvalidArgumentException('invalid length for $term when calling RelationGroupsSearchRequest., must be bigger than or equal to 0.');
        }
