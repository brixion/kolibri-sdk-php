...
/**
 * FolderTreesSearchRequest - Brixion Kolibri PHP SDK.
...
/**
 * FolderTreesSearchRequest.
 * @implements \ArrayAccess<string, mixed>
 */
class FolderTreesSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'FolderTreesSearchRequest';
    ...
    protected static $setters = [
        'folder_tree_ids' => 'setFolderTreeIds',
    ...
    protected static $getters = [
        'folder_tree_ids' => 'getFolderTreeIds',
    ...
    {
        $this->setIfExists('folder_tree_ids', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets folder_tree_ids
     *
     * @return string[]|null
     */
    public function getFolderTreeIds()
    {
        return $this->container['folder_tree_ids'];
    }

    /**
     * Sets folder_tree_ids
     *
     * @param string[]|null $folder_tree_ids Search by specific FolderTree ids.
     *
     * @return self
     */
    public function setFolderTreeIds($folder_tree_ids)
    {
        if (is_null($folder_tree_ids)) {
            throw new \InvalidArgumentException('non-nullable folder_tree_ids cannot be null');
        }
        $this->container['folder_tree_ids'] = $folder_tree_ids;
     ...
     * Sets parent_ids
     *
     * @param string[]|null $parent_ids Search by specific Parent ids.
     *
     * @return self
     */
    ...
    public function setSkip($skip)
    {
        ...
        if (($skip > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling FolderTreesSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($skip < 0)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling FolderTreesSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTake($take)
    {
        ...
        if (($take > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $take when calling FolderTreesSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($take < 0)) {
            throw new \InvalidArgumentException('invalid value for $take when calling FolderTreesSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTerm($term)
    {
        ...
        if ((mb_strlen($term) > 50)) {
            throw new \InvalidArgumentException('invalid length for $term when calling FolderTreesSearchRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($term) < 0)) {
            throw new \InvalidArgumentException('invalid length for $term when calling FolderTreesSearchRequest., must be bigger than or equal to 0.');
        }
