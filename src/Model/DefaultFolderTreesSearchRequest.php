...
/**
 * DefaultFolderTreesSearchRequest - Brixion Kolibri PHP SDK.
...
/**
 * DefaultFolderTreesSearchRequest.
 * @implements \ArrayAccess<string, mixed>
 */
class DefaultFolderTreesSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'DefaultFolderTreesSearchRequest';
    ...
    protected static $attributeTypes = [
        'default_folder_tree_ids' => 'string[]',
    ...
    protected static $attributeMap = [
        'default_folder_tree_ids' => 'defaultFolderTreeIds',
    ...
    protected static $setters = [
        'default_folder_tree_ids' => 'setDefaultFolderTreeIds',
    ...
    protected static $getters = [
        'default_folder_tree_ids' => 'getDefaultFolderTreeIds',
    ...
    {
        $this->setIfExists('default_folder_tree_ids', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets default_folder_tree_ids
     *
     * @return string[]|null
     */
    public function getDefaultFolderTreeIds()
    {
        return $this->container['default_folder_tree_ids'];
    }

    /**
     * Sets default_folder_tree_ids
     *
     * @param string[]|null $default_folder_tree_ids Search by specific Default FolderTree ids.
     *
     * @return self
     */
    public function setDefaultFolderTreeIds($default_folder_tree_ids)
    {
        if (is_null($default_folder_tree_ids)) {
            throw new \InvalidArgumentException('non-nullable default_folder_tree_ids cannot be null');
        }
        $this->container['default_folder_tree_ids'] = $default_folder_tree_ids;
    ...
    public function setSkip($skip)
    {
        ...
        if (($skip > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling DefaultFolderTreesSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($skip < 0)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling DefaultFolderTreesSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTake($take)
    {
        ...
        if (($take > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $take when calling DefaultFolderTreesSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($take < 0)) {
            throw new \InvalidArgumentException('invalid value for $take when calling DefaultFolderTreesSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTerm($term)
    {
        ...
        if ((mb_strlen($term) > 50)) {
            throw new \InvalidArgumentException('invalid length for $term when calling DefaultFolderTreesSearchRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($term) < 0)) {
            throw new \InvalidArgumentException('invalid length for $term when calling DefaultFolderTreesSearchRequest., must be bigger than or equal to 0.');
        }
