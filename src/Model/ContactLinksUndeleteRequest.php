...
/**
 * ContactLinksUndeleteRequest - Brixion Kolibri PHP SDK.
...
/**
 * ContactLinksUndeleteRequest.
 * @implements \ArrayAccess<string, mixed>
 */
class ContactLinksUndeleteRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'ContactLinksUndeleteRequest';
    ...
    protected static array $nullables = [
        'source_relation_id' => false,
        'target_relation_id' => false,
    ];
    ...
    {
        $this->setIfExists('source_relation_id', $data ?? [], null);
        $this->setIfExists('target_relation_id', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($source_relation_id)) {
            throw new \InvalidArgumentException('non-nullable source_relation_id cannot be null');
        }

        if ((mb_strlen($source_relation_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $source_relation_id when calling ContactLinksUndeleteRequest., must be bigger than or equal to 1.');
        }
    ...
    {
        if (is_null($target_relation_id)) {
            throw new \InvalidArgumentException('non-nullable target_relation_id cannot be null');
        }

        if ((mb_strlen($target_relation_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $target_relation_id when calling ContactLinksUndeleteRequest., must be bigger than or equal to 1.');
        }
