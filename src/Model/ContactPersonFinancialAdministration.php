...
/**
 * ContactPersonFinancialAdministration - Brixion Kolibri PHP SDK.
 ...
 */
class ContactPersonFinancialAdministration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'ContactPersonFinancialAdministration';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling ContactPersonFinancialAdministration., must be bigger than or equal to 1.');
        }
