...
/**
 * FinancialAdministrationsSearchRequest - Brixion Kolibri PHP SDK.
...
/**
 * FinancialAdministrationsSearchRequest.
 * @implements \ArrayAccess<string, mixed>
 */
class FinancialAdministrationsSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'FinancialAdministrationsSearchRequest';
    ...
    protected static $attributeTypes = [
        ...
        'order_by' => '\Brixion\Kolibri\Model\FinancialAdministrationOrderByField',
        'term_fields' => '\Brixion\Kolibri\Model\FinancialAdministrationTermField[]',
    ...
    */
     ...
     *
     * @param string|null $financial_administration_id Search by a specific financialAdministration Id. Used to return/refresh one search result.
     *
     * @return self
     */
     ...
     * Gets order_by
     *
     * @return \Brixion\Kolibri\Model\FinancialAdministrationOrderByField
     */
     ...
     * Sets order_by
     *
     * @param \Brixion\Kolibri\Model\FinancialAdministrationOrderByField $order_by Order the results by the indicated financialAdministration field.
     *
     * @return self
     */
     ...
     * Gets term_fields
     *
     * @return \Brixion\Kolibri\Model\FinancialAdministrationTermField[]|null
     */
     ...
     * Sets term_fields
     *
     * @param \Brixion\Kolibri\Model\FinancialAdministrationTermField[]|null $term_fields Search for given text (Term) indicated by the fields in the TermFields list. Required in case 'Term' is given.
     *
     * @return self
     */
    ...
    public function setSkip($skip)
    {
        ...
        if (($skip > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling FinancialAdministrationsSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($skip < 0)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling FinancialAdministrationsSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTake($take)
    {
        ...
        if (($take > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $take when calling FinancialAdministrationsSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($take < 0)) {
            throw new \InvalidArgumentException('invalid value for $take when calling FinancialAdministrationsSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTerm($term)
    {
        ...
        if ((mb_strlen($term) > 50)) {
            throw new \InvalidArgumentException('invalid length for $term when calling FinancialAdministrationsSearchRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($term) < 0)) {
            throw new \InvalidArgumentException('invalid length for $term when calling FinancialAdministrationsSearchRequest., must be bigger than or equal to 0.');
        }
