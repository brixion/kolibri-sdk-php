...
/**
 * LinkedDocumentTemplate - Brixion Kolibri PHP SDK.
 ...
 */
class LinkedDocumentTemplate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'LinkedDocumentTemplate';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling LinkedDocumentTemplate., must be bigger than or equal to 1.');
        }
