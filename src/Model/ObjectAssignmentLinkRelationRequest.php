...
/**
 * ObjectAssignmentLinkRelationRequest - Brixion Kolibri PHP SDK.
 ...
 */
class ObjectAssignmentLinkRelationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'ObjectAssignmentLinkRelationRequest';
    ...
    */
    ...
    public function setRelationId($relation_id)
    {
        ...
        if ((mb_strlen($relation_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $relation_id when calling ObjectAssignmentLinkRelationRequest., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string $object_assignment_id The object assignment to link the relation to.
     *
     * @return self
     */
    public function setObjectAssignmentId($object_assignment_id)
    {
        ...
        if ((mb_strlen($object_assignment_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $object_assignment_id when calling ObjectAssignmentLinkRelationRequest., must be bigger than or equal to 1.');
        }
