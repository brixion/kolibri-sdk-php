...
/**
 * DocumentSessionsSearchResponse - Brixion Kolibri PHP SDK.
...
/**
 * DocumentSessionsSearchResponse.
 * @implements \ArrayAccess<string, mixed>
 */
class DocumentSessionsSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'DocumentSessionsSearchResponse';
    ...
    protected static $attributeTypes = [
        'result_count' => 'int',
        'results' => '\Brixion\Kolibri\Model\DocumentSessionSnapShot[]',
        'total_results' => 'int',
    ];
    ...
    */
     ...
     * Sets results
     *
     * @param \Brixion\Kolibri\Model\DocumentSessionSnapShot[]|null $results results
     *
     * @return self
     */
