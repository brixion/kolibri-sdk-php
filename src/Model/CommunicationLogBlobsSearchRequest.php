...
/**
 * CommunicationLogBlobsSearchRequest - Brixion Kolibri PHP SDK.
 ...
 */
class CommunicationLogBlobsSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'CommunicationLogBlobsSearchRequest';
    ...
    protected static $attributeTypes = [
        'order_by' => '\Brixion\Kolibri\Model\CommunicationLogBlobOrderByField',
        'communication_log_id' => 'string',
        'communication_log_blob_id' => 'string',
        'term_fields' => '\Brixion\Kolibri\Model\CommunicationLogBlobTermField[]',
    ...
    */
     ...
     * Gets order_by
     *
     * @return \Brixion\Kolibri\Model\CommunicationLogBlobOrderByField
     */
     ...
     * Sets order_by
     *
     * @param \Brixion\Kolibri\Model\CommunicationLogBlobOrderByField $order_by Order the results by the indicated communicationLogBlob field.
     *
     * @return self
     */
     ...
     *
     * @param string|null $communication_log_id Search by a specific communicationLogId.
     *
     * @return self
     */
     ...
     *
     * @param string|null $communication_log_blob_id Search by a specific communicationLogBlob Id.
     *
     * @return self
     */
     ...
     * Gets term_fields
     *
     * @return \Brixion\Kolibri\Model\CommunicationLogBlobTermField[]|null
     */
     ...
     * Sets term_fields
     *
     * @param \Brixion\Kolibri\Model\CommunicationLogBlobTermField[]|null $term_fields Search for given text (Term) indicated by the fields in the TermFields list. Required in case 'Term' is given.
     *
     * @return self
     */
    ...
    public function setSkip($skip)
    {
        ...
        if (($skip > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling CommunicationLogBlobsSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($skip < 0)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling CommunicationLogBlobsSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTake($take)
    {
        ...
        if (($take > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $take when calling CommunicationLogBlobsSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($take < 0)) {
            throw new \InvalidArgumentException('invalid value for $take when calling CommunicationLogBlobsSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTerm($term)
    {
        ...
        if ((mb_strlen($term) > 50)) {
            throw new \InvalidArgumentException('invalid length for $term when calling CommunicationLogBlobsSearchRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($term) < 0)) {
            throw new \InvalidArgumentException('invalid length for $term when calling CommunicationLogBlobsSearchRequest., must be bigger than or equal to 0.');
        }
