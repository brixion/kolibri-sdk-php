...
/**
 * AgendaItemCategoriesSearchRequest - Brixion Kolibri PHP SDK.
 ...
 */
class AgendaItemCategoriesSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'AgendaItemCategoriesSearchRequest';
    ...
    protected static $attributeTypes = [
        'order_by' => '\Brixion\Kolibri\Model\AgendaItemCategoryOrderByField',
        'term_fields' => '\Brixion\Kolibri\Model\AgendaItemCategoryTermField[]',
        'culture' => 'string',
    ...
    */
     ...
     * Gets order_by
     *
     * @return \Brixion\Kolibri\Model\AgendaItemCategoryOrderByField
     */
     ...
     * Sets order_by
     *
     * @param \Brixion\Kolibri\Model\AgendaItemCategoryOrderByField $order_by Order the results by the indicated AgendaItem field.
     *
     * @return self
     */
     ...
     * Gets term_fields
     *
     * @return \Brixion\Kolibri\Model\AgendaItemCategoryTermField[]|null
     */
     ...
     * Sets term_fields
     *
     * @param \Brixion\Kolibri\Model\AgendaItemCategoryTermField[]|null $term_fields Search for given text (Term) indicated by the fields in the TermFields list. Required in case 'Term' is given.
     *
     * @return self
     */
    ...
    public function setSkip($skip)
    {
        ...
        if (($skip > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling AgendaItemCategoriesSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($skip < 0)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling AgendaItemCategoriesSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTake($take)
    {
        ...
        if (($take > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $take when calling AgendaItemCategoriesSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($take < 0)) {
            throw new \InvalidArgumentException('invalid value for $take when calling AgendaItemCategoriesSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTerm($term)
    {
        ...
        if ((mb_strlen($term) > 50)) {
            throw new \InvalidArgumentException('invalid length for $term when calling AgendaItemCategoriesSearchRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($term) < 0)) {
            throw new \InvalidArgumentException('invalid length for $term when calling AgendaItemCategoriesSearchRequest., must be bigger than or equal to 0.');
        }
