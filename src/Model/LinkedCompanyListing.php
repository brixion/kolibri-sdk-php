...
/**
 * LinkedCompanyListing - Brixion Kolibri PHP SDK.
...
/**
 * LinkedCompanyListing.
 * @implements \ArrayAccess<string, mixed>
 */
class LinkedCompanyListing implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'LinkedCompanyListing';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling LinkedCompanyListing., must be bigger than or equal to 1.');
        }
