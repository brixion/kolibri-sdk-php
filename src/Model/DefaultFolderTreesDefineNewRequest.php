...
/**
 * DefaultFolderTreesDefineNewRequest - Brixion Kolibri PHP SDK.
...
/**
 * DefaultFolderTreesDefineNewRequest.
 * @implements \ArrayAccess<string, mixed>
 */
class DefaultFolderTreesDefineNewRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'DefaultFolderTreesDefineNewRequest';
    ...
    protected static $attributeTypes = [
        'category' => '\Brixion\Kolibri\Model\DefaultFolderTreeCategory',
        'culture' => 'string',
    ];
    ...
    */
     ...
     * Gets category
     *
     * @return \Brixion\Kolibri\Model\DefaultFolderTreeCategory
     */
     ...
     * Sets category
     *
     * @param \Brixion\Kolibri\Model\DefaultFolderTreeCategory $category category
     *
     * @return self
     */
    ...
    public function setCulture($culture)
    {
        ...
        if ((mb_strlen($culture) > 5)) {
            throw new \InvalidArgumentException('invalid length for $culture when calling DefaultFolderTreesDefineNewRequest., must be smaller than or equal to 5.');
        }
        if ((mb_strlen($culture) < 0)) {
            throw new \InvalidArgumentException('invalid length for $culture when calling DefaultFolderTreesDefineNewRequest., must be bigger than or equal to 0.');
        }
