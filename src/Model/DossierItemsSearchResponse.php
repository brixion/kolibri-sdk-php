...
/**
 * DossierItemsSearchResponse - Brixion Kolibri PHP SDK.
...
/**
 * DossierItemsSearchResponse.
 * @implements \ArrayAccess<string, mixed>
 */
class DossierItemsSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'DossierItemsSearchResponse';
    ...
    protected static $attributeTypes = [
        'result_count' => 'int',
        'results' => '\Brixion\Kolibri\Model\DossierItemSnapShot[]',
        'total_results' => 'int',
    ];
    ...
    */
     ...
     * Sets results
     *
     * @param \Brixion\Kolibri\Model\DossierItemSnapShot[]|null $results results
     *
     * @return self
     */
