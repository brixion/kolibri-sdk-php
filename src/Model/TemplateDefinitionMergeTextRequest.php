...
/**
 * TemplateDefinitionMergeTextRequest - Brixion Kolibri PHP SDK.
...
/**
 * TemplateDefinitionMergeTextRequest.
 * @implements \ArrayAccess<string, mixed>
 */
class TemplateDefinitionMergeTextRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'TemplateDefinitionMergeTextRequest';
    ...
    protected static $attributeTypes = [
        'sections' => '\Brixion\Kolibri\Model\MergeSection[]',
        'culture' => 'string',
        'company_ids' => 'string[]',
        'office_ids' => 'string[]',
        'employee_ids' => 'string[]',
    ...
    */
     ...
     * Gets sections
     *
     * @return \Brixion\Kolibri\Model\MergeSection[]
     */
     ...
     * Sets sections
     *
     * @param \Brixion\Kolibri\Model\MergeSection[] $sections sections
     *
     * @return self
     */
    ...
    public function setCulture($culture)
    {
        ...
        if ((mb_strlen($culture) > 5)) {
            throw new \InvalidArgumentException('invalid length for $culture when calling TemplateDefinitionMergeTextRequest., must be smaller than or equal to 5.');
        }
        if ((mb_strlen($culture) < 0)) {
            throw new \InvalidArgumentException('invalid length for $culture when calling TemplateDefinitionMergeTextRequest., must be bigger than or equal to 0.');
        }
