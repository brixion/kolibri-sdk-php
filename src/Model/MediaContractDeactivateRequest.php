...
/**
 * MediaContractDeactivateRequest - Brixion Kolibri PHP SDK.
...
/**
 * MediaContractDeactivateRequest.
 * @implements \ArrayAccess<string, mixed>
 */
class MediaContractDeactivateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'MediaContractDeactivateRequest';
    ...
    */
    ...
    public function setMediaContractId($media_contract_id)
    {
        ...
        if ((mb_strlen($media_contract_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $media_contract_id when calling MediaContractDeactivateRequest., must be bigger than or equal to 1.');
        }
