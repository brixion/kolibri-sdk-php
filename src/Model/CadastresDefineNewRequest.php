...
/**
 * CadastresDefineNewRequest - Brixion Kolibri PHP SDK.
...
/**
 * CadastresDefineNewRequest.
 * @implements \ArrayAccess<string, mixed>
 */
class CadastresDefineNewRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'CadastresDefineNewRequest';
    ...
    */
     ...
     *
     * @param string $object_assignment_id The objectAssignment Id who is the owner of the Cadastre.
     *
     * @return self
     */
    public function setObjectAssignmentId($object_assignment_id)
    {
        ...
        if ((mb_strlen($object_assignment_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $object_assignment_id when calling CadastresDefineNewRequest., must be bigger than or equal to 1.');
        }
