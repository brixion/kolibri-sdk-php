...
/**
 * TemplateDefinitionCategoriesSearchRequest - Brixion Kolibri PHP SDK.
 ...
 */
class TemplateDefinitionCategoriesSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'TemplateDefinitionCategoriesSearchRequest';
    ...
    protected static $attributeTypes = [
        'order_by' => '\Brixion\Kolibri\Model\TemplateDefinitionCategoryOrderByField',
        'term_fields' => '\Brixion\Kolibri\Model\TemplateDefinitionCategoryTermField[]',
        'category_types' => '\Brixion\Kolibri\Model\TemplateDefinitionCategoryType[]',
        'culture' => 'string',
    ...
    */
     ...
     * Gets order_by
     *
     * @return \Brixion\Kolibri\Model\TemplateDefinitionCategoryOrderByField
     */
     ...
     * Sets order_by
     *
     * @param \Brixion\Kolibri\Model\TemplateDefinitionCategoryOrderByField $order_by Order the results by the indicated AgendaItem field.
     *
     * @return self
     */
     ...
     * Gets term_fields
     *
     * @return \Brixion\Kolibri\Model\TemplateDefinitionCategoryTermField[]|null
     */
     ...
     * Sets term_fields
     *
     * @param \Brixion\Kolibri\Model\TemplateDefinitionCategoryTermField[]|null $term_fields Search for given text (Term) indicated by the fields in the TermFields list. Required in case 'Term' is given.
     *
     * @return self
     */
     ...
     * Gets category_types
     *
     * @return \Brixion\Kolibri\Model\TemplateDefinitionCategoryType[]|null
     */
     ...
     * Sets category_types
     *
     * @param \Brixion\Kolibri\Model\TemplateDefinitionCategoryType[]|null $category_types category_types
     *
     * @return self
     */
    ...
    public function setSkip($skip)
    {
        ...
        if (($skip > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling TemplateDefinitionCategoriesSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($skip < 0)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling TemplateDefinitionCategoriesSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTake($take)
    {
        ...
        if (($take > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $take when calling TemplateDefinitionCategoriesSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($take < 0)) {
            throw new \InvalidArgumentException('invalid value for $take when calling TemplateDefinitionCategoriesSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTerm($term)
    {
        ...
        if ((mb_strlen($term) > 50)) {
            throw new \InvalidArgumentException('invalid length for $term when calling TemplateDefinitionCategoriesSearchRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($term) < 0)) {
            throw new \InvalidArgumentException('invalid length for $term when calling TemplateDefinitionCategoriesSearchRequest., must be bigger than or equal to 0.');
        }
