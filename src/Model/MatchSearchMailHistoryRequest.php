...
/**
 * MatchSearchMailHistoryRequest - Brixion Kolibri PHP SDK.
...
/**
 * MatchSearchMailHistoryRequest.
 * @implements \ArrayAccess<string, mixed>
 */
class MatchSearchMailHistoryRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'MatchSearchMailHistoryRequest';
    ...
    {
        $this->setIfExists('search_assignment_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['search_assignment_id']) < 1)) {
     ...
     *
     * @param string $search_assignment_id Specify the search assignment ID. Only mail history for this search assignment will be returned.
     *
     * @return self
     */
    public function setSearchAssignmentId($search_assignment_id)
    {
        if (is_null($search_assignment_id)) {
            throw new \InvalidArgumentException('non-nullable search_assignment_id cannot be null');
        }

        if ((mb_strlen($search_assignment_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $search_assignment_id when calling MatchSearchMailHistoryRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setSkip($skip)
    {
        ...
        if (($skip > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling MatchSearchMailHistoryRequest., must be smaller than or equal to 2147483647.');
        }
        if (($skip < 0)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling MatchSearchMailHistoryRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTake($take)
    {
        ...
        if (($take > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $take when calling MatchSearchMailHistoryRequest., must be smaller than or equal to 2147483647.');
        }
        if (($take < 0)) {
            throw new \InvalidArgumentException('invalid value for $take when calling MatchSearchMailHistoryRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTerm($term)
    {
        ...
        if ((mb_strlen($term) > 50)) {
            throw new \InvalidArgumentException('invalid length for $term when calling MatchSearchMailHistoryRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($term) < 0)) {
            throw new \InvalidArgumentException('invalid length for $term when calling MatchSearchMailHistoryRequest., must be bigger than or equal to 0.');
        }
