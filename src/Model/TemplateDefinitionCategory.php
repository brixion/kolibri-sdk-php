...
/**
 * TemplateDefinitionCategory - Brixion Kolibri PHP SDK.
...
/**
 * TemplateDefinitionCategory.
 * @implements \ArrayAccess<string, mixed>
 */
class TemplateDefinitionCategory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'TemplateDefinitionCategory';
    ...
    protected static $attributeTypes = [
        'name' => 'string',
        'description' => 'string',
        'category_type' => '\Brixion\Kolibri\Model\TemplateDefinitionCategoryType',
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TemplateDefinitionCategory., must be smaller than or equal to 200.');
        }
     ...
     * Gets category_type
     *
     * @return \Brixion\Kolibri\Model\TemplateDefinitionCategoryType
     */
     ...
     * Sets category_type
     *
     * @param \Brixion\Kolibri\Model\TemplateDefinitionCategoryType $category_type category_type
     *
     * @return self
     */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling TemplateDefinitionCategory., must be bigger than or equal to 1.');
        }
