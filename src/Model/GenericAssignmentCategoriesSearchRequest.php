...
/**
 * GenericAssignmentCategoriesSearchRequest - Brixion Kolibri PHP SDK.
...
/**
 * GenericAssignmentCategoriesSearchRequest.
 * @implements \ArrayAccess<string, mixed>
 */
class GenericAssignmentCategoriesSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'GenericAssignmentCategoriesSearchRequest';
    ...
    protected static $attributeTypes = [
        'types' => '\Brixion\Kolibri\Model\GenericAssignmentCategoryType[]',
    ...
    */
     ...
     * Gets types
     *
     * @return \Brixion\Kolibri\Model\GenericAssignmentCategoryType[]|null
     */
     ...
     * Sets types
     *
     * @param \Brixion\Kolibri\Model\GenericAssignmentCategoryType[]|null $types Search by generic assignment category types.
     *
     * @return self
     */
    ...
    public function setSkip($skip)
    {
        ...
        if (($skip > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling GenericAssignmentCategoriesSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($skip < 0)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling GenericAssignmentCategoriesSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTake($take)
    {
        ...
        if (($take > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $take when calling GenericAssignmentCategoriesSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($take < 0)) {
            throw new \InvalidArgumentException('invalid value for $take when calling GenericAssignmentCategoriesSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTerm($term)
    {
        ...
        if ((mb_strlen($term) > 50)) {
            throw new \InvalidArgumentException('invalid length for $term when calling GenericAssignmentCategoriesSearchRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($term) < 0)) {
            throw new \InvalidArgumentException('invalid length for $term when calling GenericAssignmentCategoriesSearchRequest., must be bigger than or equal to 0.');
        }
