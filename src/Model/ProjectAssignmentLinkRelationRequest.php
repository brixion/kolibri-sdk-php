...
/**
 * ProjectAssignmentLinkRelationRequest - Brixion Kolibri PHP SDK.
 ...
 */
class ProjectAssignmentLinkRelationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'ProjectAssignmentLinkRelationRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('project_assignment_id', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($project_assignment_id)) {
            throw new \InvalidArgumentException('non-nullable project_assignment_id cannot be null');
        }
