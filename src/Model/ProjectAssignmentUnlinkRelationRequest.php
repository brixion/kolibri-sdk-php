...
/**
 * ProjectAssignmentUnlinkRelationRequest - Brixion Kolibri PHP SDK.
...
/**
 * ProjectAssignmentUnlinkRelationRequest.
 * @implements \ArrayAccess<string, mixed>
 */
class ProjectAssignmentUnlinkRelationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'ProjectAssignmentUnlinkRelationRequest';
    ...
    */
    ...
    public function setRelationId($relation_id)
    {
        ...
        if ((mb_strlen($relation_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $relation_id when calling ProjectAssignmentUnlinkRelationRequest., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string $project_assignment_id The project assignment to unlink the relation from.
     *
     * @return self
     */
    public function setProjectAssignmentId($project_assignment_id)
    {
        ...
        if ((mb_strlen($project_assignment_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $project_assignment_id when calling ProjectAssignmentUnlinkRelationRequest., must be bigger than or equal to 1.');
        }
