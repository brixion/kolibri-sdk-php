...
/**
 * LinkedFolderTree - Brixion Kolibri PHP SDK.
 ...
 */
class LinkedFolderTree implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'LinkedFolderTree';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling LinkedFolderTree., must be bigger than or equal to 1.');
        }
