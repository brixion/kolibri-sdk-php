...
/**
 * RealEstateAgencySearchRequest - Brixion Kolibri PHP SDK.
...
/**
 * RealEstateAgencySearchRequest.
 * @implements \ArrayAccess<string, mixed>
 */
class RealEstateAgencySearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'RealEstateAgencySearchRequest';
    ...
    protected static $setters = [
        'app_client_key' => 'setAppClientKey',
    ...
    protected static $getters = [
        'app_client_key' => 'getAppClientKey',
    ...
    {
        $this->setIfExists('app_client_key', $data ?? [], null);
    ...
    */
     ...
     * @return string|null
     */
    public function getAppClientKey()
    {
        return $this->container['app_client_key'];
    }

    /**
     * Sets app_client_key
     *
     * @param string|null $app_client_key app_client_key
     *
     * @return self
     */
    public function setAppClientKey($app_client_key)
    {
        if (is_null($app_client_key)) {
            throw new \InvalidArgumentException('non-nullable app_client_key cannot be null');
        }
        $this->container['app_client_key'] = $app_client_key;
    ...
    public function setSkip($skip)
    {
        ...
        if (($skip > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling RealEstateAgencySearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($skip < 0)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling RealEstateAgencySearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTake($take)
    {
        ...
        if (($take > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $take when calling RealEstateAgencySearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($take < 0)) {
            throw new \InvalidArgumentException('invalid value for $take when calling RealEstateAgencySearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTerm($term)
    {
        ...
        if ((mb_strlen($term) > 50)) {
            throw new \InvalidArgumentException('invalid length for $term when calling RealEstateAgencySearchRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($term) < 0)) {
            throw new \InvalidArgumentException('invalid length for $term when calling RealEstateAgencySearchRequest., must be bigger than or equal to 0.');
        }
