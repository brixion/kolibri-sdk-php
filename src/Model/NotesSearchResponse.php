...
/**
 * NotesSearchResponse - Brixion Kolibri PHP SDK.
 ...
 */
class NotesSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'NotesSearchResponse';
    ...
    protected static $attributeTypes = [
        'result_count' => 'int',
        'results' => '\Brixion\Kolibri\Model\NoteSnapShot[]',
        'total_results' => 'int',
    ];
    ...
    */
     ...
     * Sets results
     *
     * @param \Brixion\Kolibri\Model\NoteSnapShot[]|null $results results
     *
     * @return self
     */
