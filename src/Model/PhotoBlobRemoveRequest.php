...
/**
 * PhotoBlobRemoveRequest - Brixion Kolibri PHP SDK.
 ...
 */
class PhotoBlobRemoveRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'PhotoBlobRemoveRequest';
    ...
    */
    ...
    public function setParentId($parent_id)
    {
        ...
        if ((mb_strlen($parent_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $parent_id when calling PhotoBlobRemoveRequest., must be bigger than or equal to 1.');
        }
