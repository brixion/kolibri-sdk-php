...
/**
 * TemplateDefinitionSearchRequest - Brixion Kolibri PHP SDK.
 ...
 */
class TemplateDefinitionSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'TemplateDefinitionSearchRequest';
    ...
    protected static $attributeTypes = [
        'order_by' => '\Brixion\Kolibri\Model\TemplateDefinitionOrderByField',
        'term_fields' => '\Brixion\Kolibri\Model\TemplateDefinitionTermField[]',
        'ids' => 'string[]',
    ...
    protected static array $nullables = [
        ...
        'term_fields' => false,
        'ids' => false,
        'template_definition_category_ids' => false,
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('template_definition_category_ids', $data ?? [], null);
    ...
    */
     ...
     * Gets order_by
     *
     * @return \Brixion\Kolibri\Model\TemplateDefinitionOrderByField
     */
     ...
     * Sets order_by
     *
     * @param \Brixion\Kolibri\Model\TemplateDefinitionOrderByField $order_by order_by
     *
     * @return self
     */
     ...
     * Gets term_fields
     *
     * @return \Brixion\Kolibri\Model\TemplateDefinitionTermField[]|null
     */
     ...
     * Sets term_fields
     *
     * @param \Brixion\Kolibri\Model\TemplateDefinitionTermField[]|null $term_fields term_fields
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $template_definition_category_ids template_definition_category_ids
     *
     * @return self
     */
    public function setTemplateDefinitionCategoryIds($template_definition_category_ids)
    {
        if (is_null($template_definition_category_ids)) {
            throw new \InvalidArgumentException('non-nullable template_definition_category_ids cannot be null');
        }
    ...
    public function setSkip($skip)
    {
        ...
        if (($skip > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling TemplateDefinitionSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($skip < 0)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling TemplateDefinitionSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTake($take)
    {
        ...
        if (($take > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $take when calling TemplateDefinitionSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($take < 0)) {
            throw new \InvalidArgumentException('invalid value for $take when calling TemplateDefinitionSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTerm($term)
    {
        ...
        if ((mb_strlen($term) > 50)) {
            throw new \InvalidArgumentException('invalid length for $term when calling TemplateDefinitionSearchRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($term) < 0)) {
            throw new \InvalidArgumentException('invalid length for $term when calling TemplateDefinitionSearchRequest., must be bigger than or equal to 0.');
        }
