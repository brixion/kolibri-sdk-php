...
/**
 * LeaseTerm - Brixion Kolibri PHP SDK.
 ...
 */
class LeaseTerm implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'LeaseTerm';
    ...
    protected static $attributeTypes = [
        'is_applicable' => 'bool',
        'number_of_units' => 'int',
        'unit' => '\Brixion\Kolibri\Model\LeaseTermUnit',
    ];
    ...
    {
        $this->setIfExists('is_applicable', $data ?? [], null);
    ...
    */
     ...
     * Sets is_applicable
     *
     * @param bool|null $is_applicable is_applicable
     *
     * @return self
     */
    public function setIsApplicable($is_applicable)
    {
        if (is_null($is_applicable)) {
            throw new \InvalidArgumentException('non-nullable is_applicable cannot be null');
        }
     ...
     * Gets unit
     *
     * @return \Brixion\Kolibri\Model\LeaseTermUnit|null
     */
     ...
     * Sets unit
     *
     * @param \Brixion\Kolibri\Model\LeaseTermUnit|null $unit unit
     *
     * @return self
     */
