...
/**
 * PhrasesSearchRequest - Brixion Kolibri PHP SDK.
 ...
 */
class PhrasesSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelTypeName = 'PhrasesSearchRequest';
    ...
    protected static $attributeTypes = [
        'category_id' => 'int',
        'order_by' => '\Brixion\Kolibri\Model\PhraseOrderByField',
        'term_fields' => '\Brixion\Kolibri\Model\PhraseTermField[]',
    ...
    */
     ...
     * Sets category_id
     *
     * @param int|null $category_id Search for phrases in a specific category by the category ID.
     *
     * @return self
     */
     ...
     * Gets order_by
     *
     * @return \Brixion\Kolibri\Model\PhraseOrderByField
     */
     ...
     * Sets order_by
     *
     * @param \Brixion\Kolibri\Model\PhraseOrderByField $order_by Order the results by the indicated company listing field.
     *
     * @return self
     */
     ...
     * Gets term_fields
     *
     * @return \Brixion\Kolibri\Model\PhraseTermField[]|null
     */
     ...
     * Sets term_fields
     *
     * @param \Brixion\Kolibri\Model\PhraseTermField[]|null $term_fields Search for given text (Term) indicated by the fields in the TermFields list. Required in case 'Term' is given.
     *
     * @return self
     */
    ...
    public function setSkip($skip)
    {
        ...
        if (($skip > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling PhrasesSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($skip < 0)) {
            throw new \InvalidArgumentException('invalid value for $skip when calling PhrasesSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTake($take)
    {
        ...
        if (($take > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $take when calling PhrasesSearchRequest., must be smaller than or equal to 2147483647.');
        }
        if (($take < 0)) {
            throw new \InvalidArgumentException('invalid value for $take when calling PhrasesSearchRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setTerm($term)
    {
        ...
        if ((mb_strlen($term) > 50)) {
            throw new \InvalidArgumentException('invalid length for $term when calling PhrasesSearchRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($term) < 0)) {
            throw new \InvalidArgumentException('invalid length for $term when calling PhrasesSearchRequest., must be bigger than or equal to 0.');
        }
